...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attrs) {
            ...
            this.gravity = a.getInteger(R.styleable.OpCoordinatorLayout_Layout_android_layout_gravity, TYPE_ON_INTERCEPT);
            this.mAnchorId = a.getResourceId(R.styleable.OpCoordinatorLayout_Layout_op_layout_anchor, -1);
            this.anchorGravity = a.getInteger(R.styleable.OpCoordinatorLayout_Layout_op_layout_anchorGravity, TYPE_ON_INTERCEPT);
            this.keyline = a.getInteger(R.styleable.OpCoordinatorLayout_Layout_op_layout_keyline, -1);
            this.insetEdge = a.getInt(R.styleable.OpCoordinatorLayout_Layout_op_layout_insetEdge, TYPE_ON_INTERCEPT);
            this.dodgeInsetEdges = a.getInt(R.styleable.OpCoordinatorLayout_Layout_op_layout_dodgeInsetEdges, TYPE_ON_INTERCEPT);
        ...
        public LayoutParams(com.oneplus.lib.design.widget.CoordinatorLayout.LayoutParams p) {
            super(p);
            this.mBehaviorResolved = false;
            this.gravity = 0;
            this.anchorGravity = 0;
        ...
        private boolean shouldDodge(View other, int layoutDirection) {
            int absInset = GravityCompat.getAbsoluteGravity(((com.oneplus.lib.design.widget.CoordinatorLayout.LayoutParams) other.getLayoutParams()).insetEdge, layoutDirection);
    ...
    public CoordinatorLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int keylineArrayRes = a.getResourceId(R.styleable.OpCoordinatorLayout_opKeylines, TYPE_ON_INTERCEPT);
