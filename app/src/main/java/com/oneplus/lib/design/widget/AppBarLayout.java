...
import com.oneplus.lib.design.widget.AppBarLayout.Behavior;
import com.oneplus.lib.design.widget.AppBarLayout.LayoutParams;
import com.oneplus.lib.design.widget.AppBarLayout.ScrollingViewBehavior;
...
public class AppBarLayout extends LinearLayout {
    ...
    public static class LayoutParams extends android.widget.LinearLayout.LayoutParams {
        ...
        public LayoutParams(com.oneplus.lib.design.widget.AppBarLayout.LayoutParams source) {
            super(source);
            this.mScrollFlags = 1;
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class AnonymousClass_1 implements AnimatorUpdateListener {
            ...
            AnonymousClass_1(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout) {
                this.val$coordinatorLayout = coordinatorLayout;
                this.val$child = appBarLayout;
            }

            public void onAnimationUpdate(ValueAnimator animator) {
                com.oneplus.lib.design.widget.AppBarLayout.Behavior.this.setHeaderTopBottomOffset(this.val$coordinatorLayout, this.val$child, ((Integer) animator.getAnimatedValue()).intValue());
            }
        }
        ...
        protected static class SavedState extends AbsSavedState {
            ...
            public void writeToParcel(Parcel dest, int flags) {
                ...
                dest.writeByte((byte) (this.firstVisibleChildAtMinimumHeight ? PENDING_ACTION_EXPANDED : 0));
            }
        ...
        private void animateOffsetWithDuration(CoordinatorLayout coordinatorLayout, AppBarLayout child, int offset, int duration) {
            if (getTopBottomOffsetForScrollingSibling() != offset) {
                if (this.mOffsetAnimator == null) {
                    ...
                    this.mOffsetAnimator.addUpdateListener(new AnonymousClass_1(coordinatorLayout, child));
                } else {
                    this.mOffsetAnimator.cancel();
                }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
            ...
            if (offsetChildIndex >= 0) {
                ...
                if ((flags & 17) == 17) {
                    ...
                    } else if (checkFlag(flags, RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER)) {
                    ...
                    animateOffsetTo(coordinatorLayout, abl, MathUtils.constrain(newOffset, -abl.getTotalScrollRange(), 0), AutoScrollHelper.RELATIVE_UNSPECIFIED);
                }
            }
        }
        ...
        public boolean onLayoutChild(CoordinatorLayout parent, AppBarLayout abl, int layoutDirection) {
            ...
            if (pendingAction != 0) {
                ...
                if ((pendingAction & 2) != 0) {
                    ...
                    if (animate) {
                        animateOffsetTo(parent, abl, offset, AutoScrollHelper.RELATIVE_UNSPECIFIED);
                    } else {
                        setHeaderTopBottomOffset(parent, abl, offset);
                    }
                } else if ((pendingAction & 1) != 0) {
                    if (animate) {
                        animateOffsetTo(parent, abl, 0, AutoScrollHelper.RELATIVE_UNSPECIFIED);
                    } else {
        ...
        boolean canDragView(AppBarLayout view) {
            ...
            return (scrollingView == null || !scrollingView.isShown() || ViewCompat.canScrollVertically(scrollingView, INVALID_POSITION)) ? false : true;
        }
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int newOffset, int minOffset, int maxOffset) {
            ...
            if (minOffset == 0 || curOffset < minOffset || curOffset > maxOffset) {
                ...
                if (curOffset != newOffset) {
                    ...
                    updateAppBarLayoutDrawableState(coordinatorLayout, appBarLayout, newOffset, newOffset < curOffset ? INVALID_POSITION : PENDING_ACTION_EXPANDED);
                }
            }
            return consumed;
        }
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        float getOverlapRatioForOffset(View header) {
            ...
            return availScrollRange != 0 ? 1.0f + (((float) offset) / ((float) availScrollRange)) : AutoScrollHelper.RELATIVE_UNSPECIFIED;
        }
    ...
    public void setExpanded(boolean expanded, boolean animate) {
        this.mPendingAction = (animate ? PENDING_ACTION_ANIMATE_ENABLED : 0) | (expanded ? 1 : 2);
        requestLayout();
    }
    ...
    public final int getMinimumHeightForVisibleOverlappingContent() {
        ...
        return lastChildMinHeight != 0 ? (lastChildMinHeight * 2) + topInset : getHeight() / 3;
    }
