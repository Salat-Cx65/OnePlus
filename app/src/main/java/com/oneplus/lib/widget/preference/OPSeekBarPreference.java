...
public class OPSeekBarPreference extends OPPreference implements OnSeekBarChangeListener {
    ...
    public OPSeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        setMax(LocationRequest.PRIORITY_HIGH_ACCURACY);
    ...
    protected void onBindView(View view) {
        ...
        ((SeekBar) view.findViewById(R.id.seekbar)).setVisibility(DetectedActivity.RUNNING);
    ...
    public boolean onKey(View v, int keyCode, KeyEvent event) {
        if (event.getAction() == 1 || (keyCode == 81 || keyCode == 70)) {
    ...
    void syncProgress(OPSeekBar seekBar) {
