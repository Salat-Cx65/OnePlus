...
class ChildHelper {
    ...
    static class Bucket {
        ...
        int countOnesBefore(int index) {
            return this.next == null ? index >= 64 ? Long.bitCount(this.mData) : Long.bitCount(this.mData & ((1 << index) - 1)) : index < 64 ? Long.bitCount(this.mData & ((1 << index) - 1)) : this.next.countOnesBefore(index - 64) + Long.bitCount(this.mData);
        }
