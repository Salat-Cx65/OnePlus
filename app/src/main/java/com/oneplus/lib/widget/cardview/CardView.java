...
public class CardView extends FrameLayout implements CardViewDelegate {
    ...
    private void initialize(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float radius = a.getDimension(R.styleable.CardView_cardCornerRadius, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        float op_elevation = a.getDimension(R.styleable.CardView_cardElevation, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        float maxElevation = a.getDimension(R.styleable.CardView_cardMaxElevation, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        ...
        a.recycle();
        IMPL.initialize(this, context, backgroundColor, radius, op_elevation, maxElevation);
    }
