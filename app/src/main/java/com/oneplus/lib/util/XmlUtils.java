...
public class XmlUtils {
    ...
    public static final int convertValueToInt(CharSequence charSeq, int defaultValue) {
        ...
        int index = 0;
        int len = nm.length();
        int base = ConnectionResult.DEVELOPER_ERROR;
        if ('-' == nm.charAt(0)) {
            sign = -1;
            index = 0 + 1;
        }
        if ('0' == nm.charAt(index)) {
            ...
            if ('x' == c || 'X' == c) {
                index += 2;
                base = ConnectionResult.API_UNAVAILABLE;
            } else {
                index++;
                base = DetectedActivity.RUNNING;
            }
    ...
    public static final void writeMapXml(Map val, String name, XmlSerializer out, WriteMapCallback callback) throws XmlPullParserException, IOException {
        ...
        if (name != null) {
            out.attribute(null, CityListEntry.COLUMN_2_NAME, name);
        }
    ...
    private static final java.lang.Object readThisValueXml(org.xmlpull.v1.XmlPullParser r12_parser, java.lang.String[] r13_name, com.oneplus.lib.util.XmlUtils.ReadMapCallback r14_callback, boolean r15_arrayMap) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        throw new UnsupportedOperationException("Method not decompiled: com.oneplus.lib.util.XmlUtils.readThisValueXml(org.xmlpull.v1.XmlPullParser, java.lang.String[], com.oneplus.lib.util.XmlUtils$ReadMapCallback, boolean):java.lang.Object");
        /*
        r11 = 4;
        r10 = 3;
        r9 = 2;
    ...
    L_0x0119:
        r5 = "map";
        r1 = readThisArrayMapXml(r12, r5, r13, r14);
    L_0x011f:
        r13[r7] = r4;
        goto L_0x002d;
    L_0x0123:
        r5 = "map";
        r1 = readThisMapXml(r12, r5, r13, r14);
        goto L_0x011f;
    L_0x012a:
        r5 = "list";
        r5 = r2.equals(r5);
    ...
    L_0x0132:
        r12.next();
        r5 = "list";
        r1 = readThisListXml(r12, r5, r13, r14, r15);
        r13[r7] = r4;
        goto L_0x002d;
    L_0x013f:
        r5 = "set";
    ...
    L_0x0147:
        r12.next();
        r5 = "set";
        r1 = readThisSetXml(r12, r5, r13, r14, r15);
        r13[r7] = r4;
        goto L_0x002d;
    L_0x0154:
    ...
    private static final Object readThisPrimitiveValueXml(XmlPullParser parser, String tagName) throws XmlPullParserException, IOException {
        try {
            ...
            return tagName.equals("boolean") ? Boolean.valueOf(parser.getAttributeValue(null, "value")) : null;
        } catch (NullPointerException e) {
    ...
    public static byte[] readByteArrayAttribute(XmlPullParser in, String name) {
        String value = in.getAttributeValue(null, name);
        return value != null ? Base64.decode(value, 0) : null;
    }
    ...
    public static Bitmap readBitmapAttribute(XmlPullParser in, String name) {
        ...
        return value != null ? BitmapFactory.decodeByteArray(value, 0, value.length) : null;
    }
    ...
    public static void writeBitmapAttribute(XmlSerializer out, String name, Bitmap value) throws IOException {
        if (value != null) {
            ...
            value.compress(CompressFormat.PNG, WeatherCircleView.START_ANGEL_90, os);
