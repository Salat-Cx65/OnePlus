...
public class ChoreographerCompat {
            ...
            if (this.mFrameCallback == null) {
                this.mFrameCallback = new android.view.Choreographer.FrameCallback() {
                    public void doFrame(long frameTimeNanos) {
                        com.facebook.rebound.ChoreographerCompat.FrameCallback.this.doFrame(frameTimeNanos);
                    }
                };
            }
        ...
        Runnable getRunnable() {
            if (this.mRunnable == null) {
                this.mRunnable = new Runnable() {
                    public void run() {
                        com.facebook.rebound.ChoreographerCompat.FrameCallback.this.doFrame(System.nanoTime());
                    }
                };
            }
    ...
    public void postFrameCallbackDelayed(FrameCallback callbackWrapper, long delayMillis) {
        if (IS_JELLYBEAN_OR_HIGHER) {
            ...
            this.mHandler.postDelayed(callbackWrapper.getRunnable(), 17 + delayMillis);
        }
    }
    ...
    @TargetApi(16)
    private void choreographerPostFrameCallbackDelayed(android.view.Choreographer.FrameCallback frameCallback, long delayMillis) {
