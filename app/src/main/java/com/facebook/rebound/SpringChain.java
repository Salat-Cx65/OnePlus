...
public class SpringChain implements SpringListener {
    ...
    private SpringChain(int mainTension, int mainFriction, int attachmentTension, int attachmentFriction) {
        ...
        this.mMainSpringConfig = SpringConfig.fromOrigamiTensionAndFriction((double) mainTension, (double) mainFriction);
        this.mAttachmentSpringConfig = SpringConfig.fromOrigamiTensionAndFriction((double) attachmentTension, (double) attachmentFriction);
