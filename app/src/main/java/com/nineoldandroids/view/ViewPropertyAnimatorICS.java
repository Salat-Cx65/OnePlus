...
class ViewPropertyAnimatorICS extends ViewPropertyAnimator {
    ...
    class AnonymousClass_1 implements AnimatorListener {
        ...
        AnonymousClass_1(Animator.AnimatorListener animatorListener) {
    ...
    public long getDuration() {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        return n != null ? n.getDuration() : RETURN_WHEN_NULL;
    }
    ...
    public long getStartDelay() {
        ViewPropertyAnimator n = (ViewPropertyAnimator) this.mNative.get();
        return n != null ? n.getStartDelay() : RETURN_WHEN_NULL;
    }
    ...
    public ViewPropertyAnimator setListener(Animator.AnimatorListener listener) {
        ...
        if (n != null) {
            if (listener == null) {
                ...
                n.setListener(new AnonymousClass_1(listener));
            }
        }
        return this;
    }
