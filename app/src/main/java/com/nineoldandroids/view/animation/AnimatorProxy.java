...
public final class AnimatorProxy extends Animation {
    ...
    public float getX() {
        View view = (View) this.mView.get();
        return view == null ? AutoScrollHelper.RELATIVE_UNSPECIFIED : ((float) view.getLeft()) + this.mTranslationX;
    }
    ...
    public float getY() {
        View view = (View) this.mView.get();
        return view == null ? AutoScrollHelper.RELATIVE_UNSPECIFIED : ((float) view.getTop()) + this.mTranslationY;
    }
    ...
    private void computeRect(RectF r, View view) {
        r.set(AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, (float) view.getWidth(), (float) view.getHeight());
