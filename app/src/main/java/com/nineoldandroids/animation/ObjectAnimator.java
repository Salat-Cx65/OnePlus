...
public final class ObjectAnimator extends ValueAnimator {
    ...
    public void setIntValues(int... values) {
        if (this.mValues != null && this.mValues.length != 0) {
            ...
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofInt(this.mProperty, values)});
        } else {
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofInt(this.mPropertyName, values)});
        }
    }
    ...
    public void setFloatValues(float... values) {
        if (this.mValues != null && this.mValues.length != 0) {
            ...
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(this.mProperty, values)});
        } else {
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofFloat(this.mPropertyName, values)});
        }
    }
    ...
    public void setObjectValues(Object... values) {
        if (this.mValues != null && this.mValues.length != 0) {
            ...
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofObject(this.mProperty, (TypeEvaluator) null, values)});
        } else {
            setValues(new PropertyValuesHolder[]{PropertyValuesHolder.ofObject(this.mPropertyName, (TypeEvaluator) null, values)});
        }
    }
