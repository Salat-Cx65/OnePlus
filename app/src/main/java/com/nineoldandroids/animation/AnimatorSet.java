...
public final class AnimatorSet extends Animator {
    ...
    public class Builder {
        ...
        public com.nineoldandroids.animation.AnimatorSet.Builder with(Animator anim) {
        ...
        public com.nineoldandroids.animation.AnimatorSet.Builder before(Animator anim) {
            Node node = (Node) AnimatorSet.this.mNodeMap.get(anim);
            if (node == null) {
                node = new Node(anim);
                AnimatorSet.this.mNodeMap.put(anim, node);
        ...
        public com.nineoldandroids.animation.AnimatorSet.Builder after(Animator anim) {
            Node node = (Node) AnimatorSet.this.mNodeMap.get(anim);
            if (node == null) {
                node = new Node(anim);
                AnimatorSet.this.mNodeMap.put(anim, node);
        ...
        public com.nineoldandroids.animation.AnimatorSet.Builder after(long delay) {
    ...
    public void cancel() {
        ...
        if (isStarted()) {
            ...
            if (this.mListeners != null) {
                tmpListeners = this.mListeners.clone();
    ...
    public void start() {
        ...
        if (this.mStartDelay <= 0) {
            ...
            this.mDelayAnim.addListener(new AnonymousClass_1(nodesToStart));
