...
public final class k {
    ...
    public static String b(Context context) {
        try {
            if (!StringUtils.EMPTY_STRING.equals(c)) {
                return c;
            }
    ...
    public static String d(Context context) {
        try {
            if (!StringUtils.EMPTY_STRING.equals(e)) {
                return e;
            }
            e = context.getPackageManager().getPackageInfo(context.getPackageName(), 0).versionName;
            return e == null ? StringUtils.EMPTY_STRING : e;
        } catch (Throwable th) {
    ...
    public static String e(Context context) {
        try {
            PackageInfo packageInfo = context.getPackageManager().getPackageInfo(context.getPackageName(), Type.SUCCESS);
    ...
    private static String h(Context context) throws NameNotFoundException {
        if (f == null || f.equals(StringUtils.EMPTY_STRING)) {
