...
public final class cx {
        ...
        try {
            ...
            if (z) {
                try {
                    ...
                    cw.a(th, "OffsetUtil", "cover part1");
            ...
            cw.a(th2, "OffsetUtil", "cover part2");
            return dPoint;
        }
    }
    ...
    private static double c(double d) {
        return new BigDecimal(d).setScale(DetectedActivity.RUNNING, RainSurfaceView.RAIN_LEVEL_RAINSTORM).doubleValue();
    }
}
