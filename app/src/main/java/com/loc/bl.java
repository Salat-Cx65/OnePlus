...
public final class bl {
    ...
    private bl(int i, int i2, Proxy proxy, boolean z, byte b) {
        ...
        this.k = null;
        try {
            this.j = UUID.randomUUID().toString().replaceAll("-", StringUtils.EMPTY_STRING).toLowerCase();
        } catch (Throwable th) {
    ...
    final bo a(String str, Map<String, String> map, byte[] bArr) throws j {
        ...
        try {
            ...
            e2.printStackTrace();
            throw new j(AMapException.AMAP_CLIENT_URL_EXCEPTION);
        } catch (UnknownHostException e3) {
            e3.printStackTrace();
            throw new j(AMapException.AMAP_CLIENT_UNKNOWHOST_EXCEPTION);
        } catch (SocketException e4) {
            e4.printStackTrace();
            throw new j("socket \u8fde\u63a5\u5f02\u5e38 - SocketException");
        } catch (SocketTimeoutException e5) {
            e5.printStackTrace();
            throw new j(AMapException.AMAP_CLIENT_SOCKET_TIMEOUT_EXCEPTION);
        } catch (InterruptedIOException e6) {
            throw new j("\u672a\u77e5\u7684\u9519\u8bef");
        } catch (IOException e7) {
            e7.printStackTrace();
            throw new j(AMapException.AMAP_CLIENT_IO_EXCEPTION);
        } catch (Throwable e8) {
    ...
    final void a(String str, Map<String, String> map, Map<String, String> map2, bk.a aVar) {
        ...
        if (aVar != null) {
            ...
            try {
                ...
                try {
                    a.setRequestProperty("RANGE", new StringBuilder("bytes=").append(this.i).append("-").toString());
                    a.connect();
                    ...
                    if ((i & i2) != 0) {
                        j jVar = new j(new StringBuilder("\u7f51\u7edc\u5f02\u5e38\u539f\u56e0\uff1a").append(a.getResponseMessage()).append(" \u7f51\u7edc\u5f02\u5e38\u72b6\u6001\u7801\uff1a").append(responseCode).toString());
                        aVar.d();
                    }
                    ...
                    try {
                        ...
                        while (!Thread.interrupted() && !this.g) {
                            int read = inputStream3.read(obj, 0, WeatherType.ACCU_WEATHER_RAIN_AND_SNOW);
