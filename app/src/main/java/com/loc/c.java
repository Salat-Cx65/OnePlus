    ...
    public static int a(String str, List<GeoFence> list, Bundle bundle) {
        try {
            ...
            for (int i = 0; i < optJSONArray.length(); i++) {
                ...
                poiItem.setPoiName(jSONObject2.optString(CityListEntry.COLUMN_2_NAME));
                ...
                if (bundle != null) {
                    ...
                    geoFence.setType(RainSurfaceView.RAIN_LEVEL_SHOWER);
    ...
    public final int c(String str, List<GeoFence> list, Bundle bundle) {
        try {
            ...
            for (int i2 = 0; i2 < optJSONArray.length(); i2++) {
                ...
                String optString3 = jSONObject2.optString(CityListEntry.COLUMN_2_NAME);
                ...
                geoFence.setType(RainSurfaceView.RAIN_LEVEL_DOWNPOUR);
