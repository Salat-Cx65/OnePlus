...
public final class cu {
    ...
    private String b(String str) {
        ...
        return this.A.substring((indexOf + str.length()) + 1, this.A.indexOf(new StringBuilder("</").append(str).toString()));
    }
    ...
    public final void a(Context context, boolean z, boolean z2, cf cfVar, ci ciVar, ConnectivityManager connectivityManager, cc ccVar, String str, String str2, String str3) {
        ...
        if (a.isEmpty()) {
            ...
            switch (e) {
                case RainSurfaceView.RAIN_LEVEL_NORMAL_RAIN:
                    ...
                    for (i = 1; i < a.size(); i++) {
                        ceVar = (ce) a.get(i);
                        stringBuilder.append(ceVar.c).append(",");
                        stringBuilder.append(ceVar.d).append(",");
        ...
        if (ciVar.f()) {
            if (a2) {
                stringBuilder2.append(ciVar.g().getBSSID()).append(",");
        ...
        this.d = str13;
        this.f = de.d();
        this.g = new StringBuilder("android").append(de.e()).toString();
        this.h = de.b(context);
        this.i = str15;
        this.j = str6;
        this.k = "0";
        ...
        this.v = "3.4.0";
        this.w = str2;
        this.u = StringUtils.EMPTY_STRING;
        this.x = str10;
        this.y = str11;
        this.z = d;
        this.A = str5;
    ...
    public final byte[] a() {
        ...
        if (TextUtils.isEmpty(this.d)) {
            this.d = StringUtils.EMPTY_STRING;
        }
        ...
        if (TextUtils.isEmpty(this.m)) {
            this.m = StringUtils.EMPTY_STRING;
        }
        ...
        if (TextUtils.isEmpty(this.r)) {
            this.r = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.s)) {
            this.s = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.t)) {
            this.t = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.u)) {
            this.u = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.v)) {
            this.v = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.w)) {
            this.w = StringUtils.EMPTY_STRING;
        }
        if (TextUtils.isEmpty(this.x)) {
            this.x = StringUtils.EMPTY_STRING;
        }
        ...
        int i3 = CitySearchProvider.PROVIDER_WEATHER_CHINA;
        if (this.J != null) {
        ...
        if (str != null && (this.z & 8) == 8) {
            try {
                e = str.getBytes("GBK");
                length2 = Math.min(e.length, R.styleable.AppCompatTheme_dialogTheme);
            ...
            if ((this.z & 4) == 4 || length2 <= 0) {
                ...
                while (i < length2) {
                    ...
                    byte b;
                    if (!ceVar.o || (ceVar.k == 1 || ceVar.k == 3 || ceVar.k == 4)) {
                        b = (byte) ceVar.k;
                        if (ceVar.n) {
                            b = (byte) (b | 8);
                        }
                        ...
                        length3 = ceVar.j;
                        if (length3 > 127) {
                            length3 = R.styleable.AppCompatTheme_textAppearancePopupMenuHeader;
                        } else if (length3 < -128) {
                            length3 = R.styleable.AppCompatTheme_textAppearancePopupMenuHeader;
                        }
            ...
            arrayList2 = this.F;
            min = Math.min(arrayList2.size(), MessagingStyle.MAXIMUM_RETAINED_MESSAGES);
            if (min != 0) {
                bArr[i3] = (byte) 0;
                i3++;
            } else {
            ...
            try {
                ...
                System.arraycopy(e, 0, bArr, i3, RainSurfaceView.RAIN_LEVEL_SHOWER);
                i3 += 2;
                if (!isEmpty) {
                    try {
            ...
            arrayList3 = this.G;
            i2 = Math.min(arrayList3.size(), AccessibilityNodeInfoCompat.ACTION_CUT);
            bArr2 = new byte[]{(byte) 0, (byte) 0};
            if (i2 != 0) {
                try {
                    System.arraycopy(de.a(0, bArr4), 0, bArr, i3, RainSurfaceView.RAIN_LEVEL_SHOWER);
                    i3 += 2;
                } catch (Throwable th6) {
                    i3 += 2;
                }
                ...
                try {
                    System.arraycopy(de.a(i2, bArr4), 0, bArr, i3, RainSurfaceView.RAIN_LEVEL_SHOWER);
                    i3 += 2;
                } catch (Throwable th7) {
                    i3 += 2;
                }
                ...
                while (length2 < i2) {
                    ...
                    System.arraycopy(obj, 0, bArr, length, obj.length <= 32 ? ItemTouchHelper.END : obj.length);
                    length3 = length + 32;
                    try {
        ...
        if (this.E.length() != 0) {
            ...
            length3 += a4.length;
            try {
                a4 = split2[2].getBytes("GBK");
                bArr[length3] = (byte) a4.length;
                length3++;
                System.arraycopy(a4, 0, bArr, length3, a4.length);
                length3 += a4.length;
            } catch (Throwable th2222222222222222) {
                cw.a(th2222222222222222, "Req", "buildV4Dot214");
                bArr[length3] = (byte) 0;
                length3++;
            }
