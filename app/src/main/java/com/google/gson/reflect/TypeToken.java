...
public class TypeToken<T> {
    ...
    static Type getSuperclassTypeParameter(Class<?> subclass) {
        ...
        if (!(superclass instanceof Class)) {
            return _$Gson$Types.canonicalize(((ParameterizedType) superclass).getActualTypeArguments()[0]);
        }
    ...
    public boolean isAssignableFrom(Type from) {
        ...
        if (this.type instanceof Class) {
            return this.rawType.isAssignableFrom(_$Gson$Types.getRawType(from));
        }
        ...
        if (this.type instanceof GenericArrayType) {
            boolean z;
            if (this.rawType.isAssignableFrom(_$Gson$Types.getRawType(from)) && isAssignableFrom(from, (GenericArrayType) this.type)) {
                int i = 1;
            } else {
                z = false;
            }
    ...
    private static boolean isAssignableFrom(Type from, ParameterizedType to, Map<String, Type> typeVarMap) {
        ...
        Class<?> clazz = _$Gson$Types.getRawType(from);
    ...
    public final boolean equals(Object o) {
        return (o instanceof TypeToken) && _$Gson$Types.equals(this.type, ((TypeToken) o).type);
    }
