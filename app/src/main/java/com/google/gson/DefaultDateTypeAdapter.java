...
final class DefaultDateTypeAdapter implements JsonSerializer<Date>, JsonDeserializer<Date> {
    ...
    DefaultDateTypeAdapter() {
        this(DateFormat.getDateTimeInstance(RainSurfaceView.RAIN_LEVEL_SHOWER, RainSurfaceView.RAIN_LEVEL_SHOWER, Locale.US), DateFormat.getDateTimeInstance(RainSurfaceView.RAIN_LEVEL_SHOWER, RainSurfaceView.RAIN_LEVEL_SHOWER));
    }
