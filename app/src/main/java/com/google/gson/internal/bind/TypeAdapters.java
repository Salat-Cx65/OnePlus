    ...
    static {
        ...
        BIT_SET = new TypeAdapter<BitSet>() {
            public BitSet read(JsonReader in) throws IOException {
                ...
                while (tokenType != JsonToken.END_ARRAY) {
                    boolean set;
                    switch (AnonymousClass_32.$SwitchMap$com$google$gson$stream$JsonToken[tokenType.ordinal()]) {
        ...
        NUMBER = new TypeAdapter<Number>() {
            public Number read(JsonReader in) throws IOException {
                ...
                switch (AnonymousClass_32.$SwitchMap$com$google$gson$stream$JsonToken[jsonToken.ordinal()]) {
                    case RainSurfaceView.RAIN_LEVEL_NORMAL_RAIN:
        ...
        CALENDAR = new TypeAdapter<Calendar>() {
            ...
            public void write(JsonWriter out, Calendar value) throws IOException {
                ...
                out.name(MONTH);
                out.value((long) value.get(RainSurfaceView.RAIN_LEVEL_SHOWER));
                out.name(DAY_OF_MONTH);
                out.value((long) value.get(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER));
                out.name(HOUR_OF_DAY);
                out.value((long) value.get(ConnectionResult.LICENSE_CHECK_FAILED));
                out.name(MINUTE);
                out.value((long) value.get(WeatherCircleView.ARC_DIN));
                out.name(SECOND);
                out.value((long) value.get(ConnectionResult.CANCELED));
                out.endObject();
            }
        };
        ...
        JSON_ELEMENT = new TypeAdapter<JsonElement>() {
            public JsonElement read(JsonReader in) throws IOException {
                switch (AnonymousClass_32.$SwitchMap$com$google$gson$stream$JsonToken[in.peek().ordinal()]) {
                    case RainSurfaceView.RAIN_LEVEL_NORMAL_RAIN:
