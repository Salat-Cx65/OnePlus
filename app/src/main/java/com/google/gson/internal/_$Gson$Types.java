...
public final class _$Gson$Types {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public GenericArrayTypeImpl(Type componentType) {
            this.componentType = _$Gson$Types.canonicalize(componentType);
        }
        ...
        public boolean equals(Object o) {
            return (o instanceof GenericArrayType) && _$Gson$Types.equals(this, (GenericArrayType) o);
        }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public ParameterizedTypeImpl(Type ownerType, Type rawType, Type... typeArguments) {
            ...
            this.ownerType = ownerType == null ? null : _$Gson$Types.canonicalize(ownerType);
            this.rawType = _$Gson$Types.canonicalize(rawType);
            this.typeArguments = (Type[]) typeArguments.clone();
            for (int t = 0; t < this.typeArguments.length; t++) {
                _$Gson$Preconditions.checkNotNull(this.typeArguments[t]);
                _$Gson$Types.checkNotPrimitive(this.typeArguments[t]);
                this.typeArguments[t] = _$Gson$Types.canonicalize(this.typeArguments[t]);
            }
        }
        ...
        public boolean equals(Object other) {
            return (other instanceof ParameterizedType) && _$Gson$Types.equals(this, (ParameterizedType) other);
        }
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public WildcardTypeImpl(Type[] upperBounds, Type[] lowerBounds) {
            boolean z;
            boolean z2 = true;
            _$Gson$Preconditions.checkArgument(lowerBounds.length <= 1);
            ...
            if (lowerBounds.length == 1) {
                _$Gson$Preconditions.checkNotNull(lowerBounds[0]);
                _$Gson$Types.checkNotPrimitive(lowerBounds[0]);
                if (upperBounds[0] != Object.class) {
                    z2 = false;
                }
                _$Gson$Preconditions.checkArgument(z2);
                this.lowerBound = _$Gson$Types.canonicalize(lowerBounds[0]);
                this.upperBound = Object.class;
                return;
            }
            _$Gson$Preconditions.checkNotNull(upperBounds[0]);
            _$Gson$Types.checkNotPrimitive(upperBounds[0]);
            this.lowerBound = null;
            this.upperBound = _$Gson$Types.canonicalize(upperBounds[0]);
        }
        ...
        public boolean equals(Object other) {
            return (other instanceof WildcardType) && _$Gson$Types.equals(this, (WildcardType) other);
        }
    ...
    static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
        _$Gson$Preconditions.checkArgument(supertype.isAssignableFrom(contextRawType));
    ...
    public static Type resolve(Type context, Class<?> contextRawType, Type toResolve) {
        ...
        if ((toResolve instanceof Class) && ((Class) toResolve).isArray()) {
            ...
            if (componentType != newComponentType) {
                original = arrayOf(newComponentType);
            }
            return original;
            ...
            newComponentType = resolve(context, contextRawType, componentType);
            return componentType != newComponentType ? arrayOf(newComponentType) : original2;
            ...
            if (originalLowerBound.length == 1) {
                ...
                return lowerBound != originalLowerBound[0] ? supertypeOf(lowerBound) : original4;
            } else if (originalUpperBound.length != 1) {
                return original4;
            } else {
                Type upperBound = resolve(context, contextRawType, originalUpperBound[0]);
                return upperBound != originalUpperBound[0] ? subtypeOf(upperBound) : original4;
            }
        }
    }
