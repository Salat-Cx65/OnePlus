            ...
            while (raw != Object.class) {
                for (Field field : raw.getDeclaredFields()) {
                    ...
                    if (serialize || deserialize) {
                        ...
                        BoundField boundField = createBoundField(context, field, getFieldName(field), TypeToken.get(_$Gson$Types.resolve(type.getType(), raw, field.getGenericType())), serialize, deserialize);
                ...
                type = TypeToken.get(_$Gson$Types.resolve(type.getType(), raw, raw.getGenericSuperclass()));
                raw = type.getRawType();
            }
        }
        return result;
