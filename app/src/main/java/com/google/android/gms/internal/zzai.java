...
final class zzai {
    ...
    public zzai(String str, zzc com_google_android_gms_internal_zzc) {
        this.key = str;
        this.zzaz = (long) com_google_android_gms_internal_zzc.data.length;
    ...
    public static zzai zzf(InputStream inputStream) throws IOException {
        ...
        if (com_google_android_gms_internal_zzai.zza.equals(StringUtils.EMPTY_STRING)) {
    ...
    public final boolean zza(OutputStream outputStream) {
        try {
            ...
            zzag.zza(outputStream, this.zza == null ? StringUtils.EMPTY_STRING : this.zza);
