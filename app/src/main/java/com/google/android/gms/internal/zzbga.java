...
public final class zzbga extends Fragment implements zzbff {
    private static WeakHashMap<FragmentActivity, WeakReference<zzbga>> zzaEJ;
    private int zzLj;
    ...
    public static com.google.android.gms.internal.zzbga zza(android.support.v4.app.FragmentActivity r3) {
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.zzbga.zza(android.support.v4.app.FragmentActivity):com.google.android.gms.internal.zzbga");
        /*
        r0 = zzaEJ;
        r0 = r0.get(r3);
    ...
    L_0x000a:
        r0 = r0.get();
        r0 = (com.google.android.gms.internal.zzbga) r0;
        if (r0 == 0) goto L_0x0013;
    L_0x0012:
        return r0;
    L_0x0013:
        ...
        r0 = (com.google.android.gms.internal.zzbga) r0;	 Catch:{ ClassCastException -> 0x0048 }
        if (r0 == 0) goto L_0x0027;
    L_0x0021:
        r1 = r0.isRemoving();
        if (r1 == 0) goto L_0x003d;
    L_0x0027:
        r0 = new com.google.android.gms.internal.zzbga;
        r0.<init>();
    ...
    public final void zza(String str, @NonNull zzbfe com_google_android_gms_internal_zzbfe) {
        ...
        if (this.zzLj > 0) {
            new Handler(Looper.getMainLooper()).post(new zzbgb(this, com_google_android_gms_internal_zzbfe, str));
        }
    }
