...
public final class Tasks {
    ...
    static final class zzc implements zzb {
        ...
        public zzc(int i, zzn<Void> com_google_android_gms_tasks_zzn_java_lang_Void) {
            ...
            this.zzbMn = i;
            this.zzbMg = com_google_android_gms_tasks_zzn_java_lang_Void;
        }
        ...
        private final void zzDG() {
            ...
            zzn com_google_android_gms_tasks_zzn = this.zzbMg;
            int i = this.zzbMp;
            com_google_android_gms_tasks_zzn.setException(new ExecutionException(new StringBuilder(54).append(i).append(" out of ").append(this.zzbMn).append(" underlying tasks failed").toString(), this.zzbMl));
        }
    ...
    public static <TResult> TResult await(@NonNull Task<TResult> task) throws ExecutionException, InterruptedException {
        ...
        zzbr.zzb((Object) task, (Object) "Task must not be null");
        if (task.isComplete()) {
            return zzb(task);
        }
    ...
    public static <TResult> Task<TResult> call(@NonNull Executor executor, @NonNull Callable<TResult> callable) {
        zzbr.zzb((Object) executor, (Object) "Executor must not be null");
        zzbr.zzb((Object) callable, (Object) "Callback must not be null");
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> collection) {
        ...
        while (it2.hasNext()) {
            zza(r0, com_google_android_gms_tasks_Tasks_zzc);
        }
        return com_google_android_gms_tasks_zzn;
    }
    ...
    private static void zza(Task<?> task, zzb com_google_android_gms_tasks_Tasks_zzb) {
        task.addOnSuccessListener(TaskExecutors.zzbMh, (OnSuccessListener) com_google_android_gms_tasks_Tasks_zzb);
        task.addOnFailureListener(TaskExecutors.zzbMh, (OnFailureListener) com_google_android_gms_tasks_Tasks_zzb);
    }
