...
public final class zzb {
    ...
    public static boolean zzc(Parcel parcel, int i) {
        zza(parcel, i, (int) RainSurfaceView.RAIN_LEVEL_RAINSTORM);
    ...
    public static int zzd(Parcel parcel) {
        ...
        throw new zzc(new StringBuilder(54).append("Size read is invalid start=").append(dataPosition).append(" end=").append(readInt).toString(), parcel);
    }
    ...
    public static Boolean zzd(Parcel parcel, int i) {
        ...
        zza(parcel, i, zza, (int) RainSurfaceView.RAIN_LEVEL_RAINSTORM);
    ...
    public static long zzi(Parcel parcel, int i) {
        zza(parcel, i, (int) DetectedActivity.RUNNING);
    ...
    public static Long zzj(Parcel parcel, int i) {
        ...
        zza(parcel, i, zza, (int) DetectedActivity.RUNNING);
