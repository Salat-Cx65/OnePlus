...
public class zzd<T extends SafeParcelable> extends AbstractDataBuffer<T> {
    private static final String[] zzaFB;
    private final Creator<T> zzaFC;

    static {
        zzaFB = new String[]{"data"};
    }
    ...
    public T zzas(int i) {
        ...
        SafeParcelable safeParcelable = (SafeParcelable) this.zzaFC.createFromParcel(obtain);
        obtain.recycle();
