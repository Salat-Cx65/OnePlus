...
public class zzab {
    ...
    static {
        String str = "Volley";
        TAG = str;
        DEBUG = Log.isLoggable(str, RainSurfaceView.RAIN_LEVEL_SHOWER);
    }
    ...
    private static String zzd(String str, Object... objArr) {
        ...
        for (int i = 2; i < stackTrace.length; i++) {
            if (!stackTrace[i].getClass().equals(zzab.class)) {
                ...
                str2 = str2.substring(str2.lastIndexOf(R.styleable.AppCompatTheme_checkboxStyle) + 1);
                str2 = str2.substring(str2.lastIndexOf(R.styleable.OneplusTheme_op_listItemLayout) + 1);
