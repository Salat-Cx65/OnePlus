...
public abstract class zza<T extends LifecycleDelegate> {
    ...
    private final zzo<T> zzaSy;

    public zza() {
        this.zzaSy = new zzb(this);
    }

    private final void zza(Bundle bundle, zzi com_google_android_gms_dynamic_zzi) {
        if (this.zzaSv != null) {
            com_google_android_gms_dynamic_zzi.zzb(this.zzaSv);
            return;
        }
        if (this.zzaSx == null) {
            this.zzaSx = new LinkedList();
        }
        this.zzaSx.add(com_google_android_gms_dynamic_zzi);
        if (bundle != null) {
            if (this.zzaSw == null) {
    ...
    private final void zzaR(int i) {
        while (!this.zzaSx.isEmpty() && ((zzi) this.zzaSx.getLast()).getState() >= i) {
    ...
    public final void onDestroyView() {
        if (this.zzaSv != null) {
            ...
            zzaR(RainSurfaceView.RAIN_LEVEL_SHOWER);
        }
    }
    ...
    public final void onPause() {
        if (this.zzaSv != null) {
            ...
            zzaR(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER);
        }
    }
    ...
    public final void onStop() {
        if (this.zzaSv != null) {
            ...
            zzaR(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        }
    }
