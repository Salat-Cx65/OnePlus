...
public class SunnyView extends BaseWeatherView {
    ...
    private class Star {
        ...
        public Star(float radius, float strokeWidth, float centerX, float centerY, float rotateSpeed, float startAngle, float sweepAngle, int pieces, int color) {
            this.offsetX1 = 0.0f;
            this.offsetY1 = 0.0f;
            this.mOldTime = 0;
            this.mRadius = radius;
        ...
        public boolean draw(Canvas canvas) {
            RectF oval = new RectF((this.mCenterX + this.offsetX1) - this.mRadius, ((this.mCenterY + this.offsetY1) + 1250.0f) - this.mRadius, (this.mCenterX + this.offsetX1) + this.mRadius, ((this.mCenterY + this.offsetY1) + 1250.0f) + this.mRadius);
            ...
            for (int i = BACKGROUND_NIGHT_COLOR; ((float) i) < this.mPieces; i++) {
                ...
                if (i < 2) {
                    ...
                    startAngle = (((180.0f - this.mSweepAngle) - this.mStartAngle) + (((float) (i - 2)) * 180.0f)) + this.mRotateAngle;
                    if (startAngle > 360.0f) {
                        startAngle -= 360.0f;
                    }
                    if (startAngle <= 90.0f || this.mSweepAngle + startAngle >= 270.0f) {
    ...
    private class Sun {
        ...
        public Sun(float radius, float startDegree, float rotateSpeed, int edges, int fromR, int fromG, int fromB, int toR, int toG, int toB, int fromRNight, int fromGNight, int fromBNight, int toRNight, int toGNight, int toBNight, float offset) {
            this.offsetX1 = 0.0f;
            this.offsetY1 = 0.0f;
            this.radius = 0.0f;
        ...
        protected Point getNextPoint(int index) {
            ...
            return new Point((int) (((((double) (this.scale * this.radius)) * Math.cos(radian)) + ((double) this.centerX)) + ((double) this.offsetX1)), (int) (((((double) (this.scale * this.radius)) * Math.sin(radian)) + ((double) this.centerY)) + ((double) this.offsetY1)));
        }
    ...
    private class Shine extends Sun {
        ...
        public Shine(float radius, float startDegree, float rotateSpeed, int edges, int fromR, int fromG, int fromB, int toR, int toG, int toB, float offset) {
            super(radius, startDegree, rotateSpeed, edges, fromR, fromG, fromB, toR, toG, toB, fromR, fromG, fromB, toR, toG, toB, offset);
            this.mPath = new Path();
    ...
    private void init() {
        ...
        arrayList.add(new Sun(((float) x) * (98.0f * this.mDesity), 15.0f, 15.6f, 12, 144, 195, 186, 195, 217, 138, 8, 24, 46, 11, 31, 57, 0.0f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (87.0f * this.mDesity), 0.0f, 13.7f, 12, 183, 198, 136, 221, 201, 87, 10, 29, 52, 14, 37, 68, this.mDesity * 16.666666f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (76.0f * this.mDesity), 15.0f, 11.7f, 12, 206, 186, 99, 228, 174, 63, 12, 32, 59, 18, 44, 80, this.mDesity * 33.333332f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (63.0f * this.mDesity), 0.0f, 9.8f, 12, 215, 167, 78, 223, 149, 58, 15, 37, 66, 25, 55, 95, this.mDesity * 50.0f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (52.333332f * this.mDesity), 15.0f, 7.8f, 12, 218, 145, 68, 220, 123, 59, 18, 42, 72, 31, 64, 107, this.mDesity * 66.666664f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (42.333332f * this.mDesity), 30.0f, 5.9f, 10, 216, 125, 60, 215, 105, 52, 23, 50, 82, 40, 74, 118, this.mDesity * 83.333336f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (31.666666f * this.mDesity), 10.0f, 3.9f, 10, 213, 106, 53, 211, 87, 46, 30, 60, 95, 49, 88, 129, this.mDesity * 116.666664f));
        arrayList = this.mSunList;
        arrayList.add(new Sun(((float) x) * (20.333334f * this.mDesity), 25.0f, 2.0f, 10, 209, 70, 40, 209, 70, 40, 56, 103, 134, 56, 103, 134, this.mDesity * 150.0f));
        ...
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 362.66666f), (float) UIUtil.dip2px(getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#82ece1")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 394.33334f), (float) UIUtil.dip2px(getContext(), 0.6666667f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 446.0f), (float) UIUtil.dip2px(getContext(), 0.6666667f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 486.66666f), (float) UIUtil.dip2px(getContext(), 1.3333334f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 530.0f), (float) UIUtil.dip2px(getContext(), 1.3333334f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 565.0f), (float) UIUtil.dip2px(getContext(), 0.6666667f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#82ece1")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 638.3333f), (float) UIUtil.dip2px(getContext(), 0.6666667f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 654.6667f), (float) UIUtil.dip2px(getContext(), 0.6666667f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 846.0f), (float) UIUtil.dip2px(getContext(), 1.3333334f), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#ffffff")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 963.0f), (float) UIUtil.dip2px(getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), centerX, centerY, 0.0f, -90.0f, 180.0f, 1, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 377.66666f), (float) UIUtil.dip2px(getContext(), 1.1666666f), centerX, centerY, 0.036f, 10.0f, 34.5f, 2, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 422.66666f), (float) UIUtil.dip2px(getContext(), 2.0f), centerX, centerY, 0.018f, 16.0f, 17.7f, 4, Color.parseColor("#ffffff")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 519.3333f), (float) UIUtil.dip2px(getContext(), 1.3333334f), centerX, centerY, 0.018f, 29.0f, 30.5f, 4, Color.parseColor("#82ece1")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 545.0f), (float) UIUtil.dip2px(getContext(), 2.6666667f), centerX, centerY, 0.036f, 5.0f, 50.0f, 2, Color.parseColor("#ffffff")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 554.0f), (float) UIUtil.dip2px(getContext(), 1.6666666f), centerX, centerY, 0.054f, 5.0f, 37.5f, 4, Color.parseColor("#bdf3ee")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 593.0f), (float) UIUtil.dip2px(getContext(), 2.8333333f), centerX, centerY, 0.018f, 33.0f, 24.6f, 4, Color.parseColor("#ffffff")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 606.6667f), (float) UIUtil.dip2px(getContext(), 1.6666666f), centerX, centerY, 0.054f, 11.0f, 24.5f, 4, Color.parseColor("#82ece1")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 661.0f), (float) UIUtil.dip2px(getContext(), 1.6666666f), centerX, centerY, 0.036f, 43.0f, 23.0f, 2, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 685.6667f), (float) UIUtil.dip2px(getContext(), 1.8333334f), centerX, centerY, 0.036f, 6.0f, 37.0f, 4, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 707.0f), (float) UIUtil.dip2px(getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), centerX, centerY, 0.018f, 21.0f, 26.0f, 4, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 746.6667f), (float) UIUtil.dip2px(getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT), centerX, centerY, 0.018f, 14.0f, 24.5f, 4, Color.parseColor("#6a9b95")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 757.3333f), (float) UIUtil.dip2px(getContext(), 2.0f), centerX, centerY, 0.036f, 4.0f, 26.3f, 2, Color.parseColor("#c8fff9")));
        this.mStarList.add(new Star((float) UIUtil.dip2px(getContext(), 793.0f), (float) UIUtil.dip2px(getContext(), 2.0f), centerX, centerY, 0.018f, 18.0f, 26.0f, 4, Color.parseColor("#82ece1")));
    }
            ...
            if (isDay()) {
                ...
                for (i = BACKGROUND_NIGHT_COLOR; i < this.mSunList.size(); i++) {
                    if (!(this.mSunList.get(i) instanceof Shine) || this.mDeltaAngleY <= -110.0f) {
                        ((Sun) this.mSunList.get(i)).updateRoatationInfo(AutoScrollHelper.RELATIVE_UNSPECIFIED, this.mDeltaAngleY, this.mDeltaAngleZ, this.offsetX1, this.offsetY1, this.scale);
                        ((Sun) this.mSunList.get(i)).draw(canvas);
                    }
                }
            } else {
                for (i = BACKGROUND_NIGHT_COLOR; i < this.mStarList.size(); i++) {
                    ((Star) this.mStarList.get(i)).updateRoatationInfo(AutoScrollHelper.RELATIVE_UNSPECIFIED, this.mDeltaAngleY, this.mDeltaAngleZ, this.offsetX1, this.offsetY1);
