...
public class CommonCandidateCity {
    ...
    public CommonCandidateCity(String mCityCode, String mCityname, String mCityProvince, String mCityCountry, String mCityCountryID, int provider) {
        this(mCityCode, mCityname, mCityname, mCityname, mCityProvince, mCityProvince, mCityProvince, mCityCountry, mCityCountry, mCityCountry, mCityCountryID, provider);
    }

    public CommonCandidateCity(String mCityCode, String mCitynameChs, String mCitynameCht, String mCitynameEn, String mCityProvinceChs, String mCityProvinceCht, String mCityProvinceEn, String mCityCountryChs, String mCityCountryCht, String mCityCountryEn, String mCityCountryID, int provider) {
        this.mProvider = 1;
    ...
    public String getCityName(Context context) {
        ...
        return ("tw".equalsIgnoreCase(locale.getCountry()) || "hk".equalsIgnoreCase(locale.getCountry()) || "mo".equalsIgnoreCase(locale.getCountry())) ? this.mCityNameCht : this.mCityNameEn;
    }
    ...
    public String getCityProvince(Context context) {
        ...
        return ("tw".equalsIgnoreCase(locale.getCountry()) || "hk".equalsIgnoreCase(locale.getCountry()) || "mo".equalsIgnoreCase(locale.getCountry())) ? this.mCityProvinceCht : this.mCityProvinceEn;
    }
    ...
    public String getCityCountry(Context context) {
        ...
        return ("tw".equalsIgnoreCase(locale.getCountry()) || "hk".equalsIgnoreCase(locale.getCountry()) || "mo".equalsIgnoreCase(locale.getCountry())) ? this.mCityCountryCht : this.mCityCountryEn;
    }
    ...
    public int hashCode() {
        return this.mCityCode.equals(StarWarUtils.STATWAR_NAME) ? -1 : Integer.valueOf(this.mCityCode).intValue();
    }
}
