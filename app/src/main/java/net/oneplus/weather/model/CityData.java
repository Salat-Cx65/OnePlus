...
public class CityData {
    ...
    public static CityData parse(ContentValues values) {
        ...
        city.setId((long) values.getAsInteger("_id").intValue());
        if (city.getId() != 0) {
            city.setLocatedCity(false);
        } else {
            city.setLocatedCity(true);
        }
        city.setProvider(values.getAsInteger(CityListEntry.COLUMN_1_PROVIDER).intValue());
        ...
        city.setLocationId(values.getAsString(WeatherEntry.COLUMN_1_LOCATION_ID));
