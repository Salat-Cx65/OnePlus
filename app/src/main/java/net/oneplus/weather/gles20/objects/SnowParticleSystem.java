...
public class SnowParticleSystem {
    ...
    public void addPolyhedronParticle(float[] snowPositions, int size, int color, Vector direction, float particleStartTime, float alpha) {
    ...
    public void addPointParticle(Point point, int size, int color, Vector direction, float particleStartTime, float alpha) {
    ...
    public void bindData(SnowShaderProgram particleProgram, VertexArray vertexArray) {
        vertexArray.setVertexAttribPointer(0, particleProgram.getPositionAttributeLocation(), VECTOR_COMPONENT_COUNT, STRIDE);
        int dataOffset = 0 + 3;
        vertexArray.setVertexAttribPointer(dataOffset, particleProgram.getColorAttributeLocation(), VECTOR_COMPONENT_COUNT, STRIDE);
        dataOffset += 3;
        ...
        dataOffset += 3;
        vertexArray.setVertexAttribPointer(dataOffset, particleProgram.getParticleStartTimeAttributeLocation(), SIZE_COMPONENT_COUNT, STRIDE);
        dataOffset++;
        vertexArray.setVertexAttribPointer(dataOffset, particleProgram.getSizeAttributeLocation(), SIZE_COMPONENT_COUNT, STRIDE);
        vertexArray.setVertexAttribPointer(dataOffset + 1, particleProgram.getAlphaAttributeLocation(), SIZE_COMPONENT_COUNT, STRIDE);
    }
