...
import net.oneplus.weather.gles20.objects.SnowParticleFlurry;
import net.oneplus.weather.gles20.objects.SnowParticleNormal;
import net.oneplus.weather.gles20.objects.SnowParticleShooter;
import net.oneplus.weather.gles20.objects.SnowParticleStorm;
import net.oneplus.weather.gles20.objects.SnowParticleSystem;
...
public class SnowRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.snowParticleSystem = new SnowParticleSystem(this.SNOW_PARTICLE_COUNT_POLYHEDRON, this.SNOW_PARTICLE_COUNT_POINT);
        this.globalStartTime = System.nanoTime();
        this.polyhedronTexture = TextureHelper.loadTexture(this.mContext, R.drawable.snow);
        this.pointTexture = TextureHelper.loadTexture(this.mContext, R.drawable.snow_point);
    }
    ...
    private void updateModelMatrices() {
        ...
        Matrix.translateM(this.modelMatrix, SNOW_LEVEL_FLURRY, AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, -2.0f);
        Matrix.rotateM(this.modelMatrix, SNOW_LEVEL_FLURRY, this.xRotation, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED, 0.0f);
    ...
    private void drawSnowParticles() {
        ...
        this.snowShaderProgram.useProgram();
        this.snowShaderProgram.setUniforms(this.modelProjectionMatrix, currentTime, this.polyhedronTexture, this.mAlpha);
