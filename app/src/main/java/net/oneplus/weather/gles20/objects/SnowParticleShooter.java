...
import net.oneplus.weather.gles20.util.Geometry.Point;
...
public class SnowParticleShooter {
    ...
    public SnowParticleShooter(Vector direction, int color1, int color2) {
    ...
    public void addParticles(SnowParticleSystem particleSystem, float currentTime, int count) {
        ...
        while (i < count) {
            ...
            if (nextFloat <= this.RATE_ADD_PARTICLE) {
                int i2;
                this.x = ((((float) this.random.nextInt(10000)) / 10000.0f) * this.X_RANDOM_RANGE) - (this.X_RANDOM_RANGE / 2.0f);
                ...
                Matrix.setRotateEulerM(this.rotationMatrix, 0, (this.random.nextFloat() - 0.5f) * 45.0f, (this.random.nextFloat() - 0.5f) * 45.0f, (this.random.nextFloat() - 0.5f) * 45.0f);
                Matrix.multiplyMV(this.resultVector, 0, this.rotationMatrix, 0, this.directionVector, 0);
                if (nextFloat > this.RATE_POLYHEDRON) {
                    this.size = (int) (((((float) this.random.nextInt(10000)) / 10000.0f) * ((float) this.SIZE_RANGE_POINT)) + ((float) this.SIZE_OFFSET_POINT));
                    if (!this.isAlpha) {
                        float f;
                        ...
                        this.a_alpha = f;
                        this.speedAdjustment = ((this.speedAdjustment * ((float) this.size)) / ((float) this.SIZE_RANGE_POINT)) + (((float) (this.random.nextInt(10000) / 10000)) * this.SPEED_CHANGE_RANGE);
                    }
                    particleSystem.addPointParticle(new Point(this.x, this.y, this.z), this.size, this.color, new Vector(this.resultVector[0] * this.speedAdjustment, this.resultVector[1] * this.speedAdjustment, this.resultVector[2] * this.speedAdjustment), currentTime, this.a_alpha);
                } else {
                    addSnowPosition();
                    ...
                    particleSystem.addPolyhedronParticle(this.snowPositions, this.size, this.color, new Vector(this.resultVector[0] * this.speedAdjustment, this.resultVector[1] * this.speedAdjustment, this.resultVector[2] * this.speedAdjustment), currentTime, this.a_alpha);
                }
                i++;
            } else {
                return;
    ...
    private void addSnowPosition() {
        this.z *= 0.8f;
        float aHalf = ((((float) this.random.nextInt(10000)) / 10000.0f) * this.SIZE_RANGE_POLYHEDRON) + this.SIZE_OFFSET_POLYHEDRON;
    ...
    private void initAlFaceIndex20(ArrayList<Integer> alFaceIndex20) {
        ...
        alFaceIndex20.add(Integer.valueOf(1));
        alFaceIndex20.add(Integer.valueOf(1));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.RESOLUTION_REQUIRED));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.WALKING));
        alFaceIndex20.add(Integer.valueOf(1));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.WALKING));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_SHOWER));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_SHOWER));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.WALKING));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.RUNNING));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_SHOWER));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.RUNNING));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_DOWNPOUR));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_DOWNPOUR));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.RUNNING));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.SERVICE_INVALID));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_DOWNPOUR));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.SERVICE_INVALID));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_RAINSTORM));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_RAINSTORM));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.SERVICE_INVALID));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.DEVELOPER_ERROR));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_RAINSTORM));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.DEVELOPER_ERROR));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER));
        alFaceIndex20.add(Integer.valueOf(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER));
        ...
        alFaceIndex20.add(Integer.valueOf(1));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.RESOLUTION_REQUIRED));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.LICENSE_CHECK_FAILED));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.WALKING));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.WALKING));
        alFaceIndex20.add(Integer.valueOf(ConnectionResult.LICENSE_CHECK_FAILED));
        alFaceIndex20.add(Integer.valueOf(DetectedActivity.RUNNING));
