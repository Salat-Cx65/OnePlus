...
import net.oneplus.weather.gles20.objects.RainParticles;
import net.oneplus.weather.gles20.objects.RainStromParticles;
...
public class RainRenderer implements Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        this.texture = TextureHelper.loadTexture(this.mContext, R.drawable.rain);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        MatrixHelper.perspectiveM(this.projectionMatrix, 45.0f, ((float) width) / ((float) height), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 200.0f);
        updateModelMatrices();
    }
    ...
    private void updateModelMatrices() {
        ...
        Matrix.translateM(this.modelMatrix, RAIN_LEVEL_DRIZZLE, AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, -2.0f);
        Matrix.rotateM(this.modelMatrix, RAIN_LEVEL_DRIZZLE, -this.xRotation, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED, 0.0f);
    ...
    private void drawRainParticles() {
        ...
        this.rainParticles.changePosition(currentTime, this.modelProjectionMatrix, this.rainDropsTextture, this.rainAlpha, this.xRotation, this.zRotation, this.rainDropsOrientationMatrix);
    ...
    private void updateMvpMatrix() {
        Matrix.multiplyMM(this.modelProjectionMatrix, RAIN_LEVEL_DRIZZLE, this.projectionMatrix, 0, this.modelMatrix, 0);
    }
