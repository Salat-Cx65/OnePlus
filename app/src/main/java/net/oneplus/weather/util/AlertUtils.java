...
public class AlertUtils {
    ...
    public static CenterAlertDialog showCenterAlert(Context context, String title, String message, String confirmText, View.OnClickListener confirm, String cancelText, View.OnClickListener cancel) {
    ...
    public static Dialog showNoConnectionDialog(Context context) {
        ...
        builder.setMessage((int) R.string.warning_string_no_network).setPositiveButton((int) R.string.open, new AnonymousClass_2(context)).setNegativeButton((int) R.string.warning_string_dismiss, new OnClickListener() {
    ...
    public static Dialog showProgressDialog(Context context, String message) {
        ...
        View layout = new LinearLayout(context.getApplicationContext());
        ...
        if (TextUtils.isEmpty(message)) {
            layout.setGravity(ConnectionResult.SIGN_IN_FAILED);
        } else {
            layout.setGravity(ConnectionResult.SERVICE_MISSING_PERMISSION);
        ...
        OPAlertDialog dialog = builder.create();
        dialog.setCanceledOnTouchOutside(false);
        dialog.show();
        dialog.getWindow().getDecorView().findViewById(16908331).setLayoutParams(new LayoutParams(-1, 200));
        return dialog;
    }
    ...
    public static Dialog showNonePermissionDialog(Activity activity) {
        OPAlertDialog dialog = new Builder(activity).setMessage((int) R.string.dialog_necessary_permissions).setPositiveButton((int) R.string.dialog_go_to_settings, new AnonymousClass_4(activity)).setNegativeButton((int) R.string.dialog_exit, new AnonymousClass_3(activity)).create();
        dialog.show();
