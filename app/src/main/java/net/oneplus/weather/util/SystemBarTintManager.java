...
public class SystemBarTintManager {
    ...
    public static class SystemBarConfig {
        ...
        private int getNavigationBarHeight(Context context) {
            ...
            return getInternalDimensionSize(res, this.mInPortrait ? NAV_BAR_HEIGHT_RES_NAME : NAV_BAR_HEIGHT_LANDSCAPE_RES_NAME);
        }
        ...
        private boolean hasNavBar(Context context) {
            ...
            if (resourceId != 0) {
                ...
                return !ViewConfiguration.get(context).hasPermanentMenuKey() ? 1 : null;
            }
        }
    ...
    public void setStatusBarTintEnabled(boolean enabled) {
        ...
        if (this.mStatusBarAvailable) {
            this.mStatusBarTintView.setVisibility(enabled ? 0 : DetectedActivity.RUNNING);
        }
    }
    ...
    public void setNavigationBarTintEnabled(boolean enabled) {
        ...
        if (this.mNavBarAvailable) {
            this.mNavBarTintView.setVisibility(enabled ? 0 : DetectedActivity.RUNNING);
        }
    }
    ...
    private void setupStatusBarView(Context context, ViewGroup decorViewGroup) {
        ...
        this.mStatusBarTintView.setVisibility(DetectedActivity.RUNNING);
    ...
    private void setupNavBarView(Context context, ViewGroup decorViewGroup) {
        ...
        this.mNavBarTintView.setVisibility(DetectedActivity.RUNNING);
