...
public class SwaCurrentWeather extends CurrentWeather {
    ...
    public SwaCurrentWeather(String areaCode, int weatherId, Date observationDate, Temperature temperature, int relativeHumidity, Wind wind, int UVIndex, String UVIndexText) {
