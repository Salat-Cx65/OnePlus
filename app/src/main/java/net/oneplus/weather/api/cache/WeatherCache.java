...
import net.oneplus.weather.api.cache.DiskLruCache.Snapshot;
            ...
            if (this.mDiskLruCache == null || this.mDiskLruCache.isClosed()) {
                ...
                if (diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > 1048576) {
                        try {
                            this.mDiskLruCache = DiskLruCache.open(diskCacheDir, VERSION_CODE, VERSION_CODE, PlaybackStateCompat.ACTION_SET_CAPTIONING_ENABLED);
