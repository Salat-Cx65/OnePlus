...
public abstract class DocumentFile {
    ...
    public static DocumentFile fromSingleUri(Context context, Uri singleUri) {
        return VERSION.SDK_INT >= 19 ? new SingleDocumentFile(null, context, singleUri) : null;
    }

    public static DocumentFile fromTreeUri(Context context, Uri treeUri) {
        return VERSION.SDK_INT >= 21 ? new TreeDocumentFile(null, context, DocumentsContractApi21.prepareTreeUri(treeUri)) : null;
    }
