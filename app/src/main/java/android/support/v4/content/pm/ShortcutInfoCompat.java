...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setShortLabel(@NonNull CharSequence shortLabel) {
            this.mInfo.mLabel = shortLabel;
            return this;
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setLongLabel(@NonNull CharSequence longLabel) {
            this.mInfo.mLongLabel = longLabel;
            return this;
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setDisabledMessage(@NonNull CharSequence disabledMessage) {
            this.mInfo.mDisabledMessage = disabledMessage;
            return this;
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setIntent(@NonNull Intent intent) {
            return setIntents(new Intent[]{intent});
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setIntents(@NonNull Intent[] intents) {
            this.mInfo.mIntents = intents;
            return this;
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setIcon(@NonNull Bitmap icon) {
            return setIcon(IconCompat.createWithBitmap(icon));
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setIcon(@DrawableRes int icon) {
            return setIcon(IconCompat.createWithResource(this.mInfo.mContext, icon));
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setIcon(IconCompat icon) {
            this.mInfo.mIcon = icon;
            return this;
        }

        @NonNull
        public android.support.v4.content.pm.ShortcutInfoCompat.Builder setActivity(@NonNull ComponentName activity) {
