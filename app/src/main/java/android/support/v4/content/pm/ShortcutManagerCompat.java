...
public class ShortcutManagerCompat {
    ...
    static class AnonymousClass_1 extends BroadcastReceiver {
        final /* synthetic */ IntentSender val$callback;

        AnonymousClass_1(IntentSender intentSender) {
    ...
    public static boolean requestPinShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcut, @Nullable IntentSender callback) {
        ...
        context.sendOrderedBroadcast(intent, null, new AnonymousClass_1(callback), null, -1, null, null);
        return true;
    }
