...
public final class BundleCompat {
    ...
    static class BundleCompatBaseImpl {
        ...
        public static android.os.IBinder getBinder(android.os.Bundle r8_bundle, java.lang.String r9_key) {
        ...
        /* JADX WARNING: inconsistent code. */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public static void putBinder(android.os.Bundle r7_bundle, java.lang.String r8_key, android.os.IBinder r9_binder) {
    ...
    public static IBinder getBinder(Bundle bundle, String key) {
        return VERSION.SDK_INT >= 18 ? bundle.getBinder(key) : BundleCompatBaseImpl.getBinder(bundle, key);
    }
