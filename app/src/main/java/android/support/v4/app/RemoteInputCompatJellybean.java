...
class RemoteInputCompatJellybean {
    ...
    static Bundle getResultsFromIntent(Intent intent) {
        ...
        return clipDataIntent == null ? null : (Bundle) clipDataIntent.getExtras().getParcelable(EXTRA_RESULTS_DATA);
    }
    ...
    private static Intent getClipDataIntentFromIntent(Intent intent) {
        ...
        return (clipDescription.hasMimeType("text/vnd.android.intent") && clipDescription.getLabel().equals(RESULTS_CLIP_LABEL)) ? clipData.getItemAt(0).getIntent() : null;
    }
}
