...
final class FragmentManagerImpl extends FragmentManager implements Factory2 {
    ...
    class AnonymousClass_3 extends AnimatorListenerAdapter {
        ...
        AnonymousClass_3(ViewGroup viewGroup, View view, Fragment fragment) {
    ...
    class AnonymousClass_4 extends AnimatorListenerAdapter {
        ...
        AnonymousClass_4(ViewGroup viewGroup, View view, Fragment fragment) {
            this.val$container = viewGroup;
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (this.val$fragment.mView != null) {
                this.val$fragment.mView.setVisibility(DetectedActivity.RUNNING);
            }
        }
    }
    ...
    private static class AnimatorOnHWLayerIfNeededListener extends AnimatorListenerAdapter {
        ...
        public void onAnimationStart(Animator animation) {
            this.mView.setLayerType(ANIM_STYLE_OPEN_EXIT, null);
        }
    ...
    class AnonymousClass_2 extends AnimationListenerWrapper {
        final /* synthetic */ Fragment val$fragment;

        AnonymousClass_2(AnimationListener wrapped, Fragment fragment) {
            this.val$fragment = fragment;
            super(null);
        }
    ...
    static boolean shouldRunOnHWLayer(View v, AnimationOrAnimator anim) {
        return v != null && anim != null && VERSION.SDK_INT >= 19 && v.getLayerType() == 0 && ViewCompat.hasOverlappingRendering(v) && modifiesAlpha(anim);
    }
    ...
    AnimationOrAnimator loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case ANIM_STYLE_OPEN_ENTER:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_OPEN_EXIT:
                return makeOpenCloseAnimation(this.mHost.getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED);
            case ANIM_STYLE_CLOSE_ENTER:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_CLOSE_EXIT:
                return makeOpenCloseAnimation(this.mHost.getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, 1.075f, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED);
            case ANIM_STYLE_FADE_ENTER:
                return makeFadeAnimation(this.mHost.getContext(), AutoScrollHelper.RELATIVE_UNSPECIFIED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            case ANIM_STYLE_FADE_EXIT:
                return makeFadeAnimation(this.mHost.getContext(), DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED);
            default:
    ...
    void moveToState(Fragment f, int newState, int transit, int transitionStyle, boolean keepActive) {
        ...
        if (f.mRemoving && newState > f.mState) {
            newState = (f.mState == 0 && f.isInBackStack()) ? ANIM_STYLE_OPEN_ENTER : f.mState;
        }
                        ...
                        if (newState > 0) {
                            ...
                            if (f.mTarget != null) {
                                if (this.mActive.get(f.mTarget.mIndex) != f.mTarget) {
                                    ...
                                    moveToState(f.mTarget, ANIM_STYLE_OPEN_ENTER, 0, 0, true);
                                }
                            }
                        ...
                        if (newState > 1) {
                            ...
                            if (!f.mFromLayout) {
                                ...
                                if (f.mContainerId != 0) {
                                    ...
                                    container = this.mContainer.onFindViewById(f.mContainerId);
                                ...
                                if (f.mView == null) {
                                    ...
                                    if (f.mHidden) {
                                        f.mView.setVisibility(DetectedActivity.RUNNING);
                                    }
                                    f.onViewCreated(f.mView, f.mSavedFragmentState);
                                    dispatchOnFragmentViewCreated(f, f.mView, f.mSavedFragmentState, false);
                                    z = (f.mView.getVisibility() == 0 || f.mContainer == null) ? false : true;
                                    f.mIsNewlyAdded = z;
                                } else {
                                    f.mInnerView = null;
                                }
                    ...
                    if (newState < 1) {
                        if (this.mDestroyed) {
                            if (f.getAnimatingAway() != null) {
                                v = f.getAnimatingAway();
                                f.setAnimatingAway(null);
                                v.clearAnimation();
                            } else if (f.getAnimator() != null) {
                                animator = f.getAnimator();
                                f.setAnimator(null);
                                animator.cancel();
                            }
                        }
    ...
    private void animateRemoveFragment(@NonNull Fragment fragment, @NonNull AnimationOrAnimator anim, int newState) {
        ...
        if (anim.animation != null) {
            ...
            animation.setAnimationListener(new AnonymousClass_2(getAnimationListener(animation), fragment));
        ...
        animator.addListener(new AnonymousClass_3(container, viewToAnimate, fragment));
    ...
    void completeShowHideFragment(Fragment fragment) {
        if (fragment.mView != null) {
            ...
            if (anim == null || anim.animator == null) {
                ...
                int visibility = (!fragment.mHidden || fragment.isHideReplaced()) ? 0 : DetectedActivity.RUNNING;
                ...
                if (!fragment.mHidden) {
                    ...
                    anim.animator.addListener(new AnonymousClass_4(container, animatingView, fragment));
                }
                setHWLayerAnimListenerIfAlpha(fragment.mView, anim);
                anim.animator.start();
            }
    ...
    public void dispatchCreate() {
        this.mStateSaved = false;
        dispatchStateChange(ANIM_STYLE_OPEN_ENTER);
    }

    public void dispatchActivityCreated() {
        this.mStateSaved = false;
        dispatchStateChange(ANIM_STYLE_OPEN_EXIT);
    }

    public void dispatchStart() {
        this.mStateSaved = false;
        dispatchStateChange(ANIM_STYLE_CLOSE_EXIT);
    }

    public void dispatchResume() {
        this.mStateSaved = false;
        dispatchStateChange(ANIM_STYLE_FADE_ENTER);
    }
    ...
    public void dispatchStop() {
        this.mStateSaved = true;
        dispatchStateChange(ANIM_STYLE_CLOSE_ENTER);
    }
