...
public class ActionBarDrawerToggle implements DrawerListener {
    ...
    private class SlideDrawable extends InsetDrawable implements Callback {
        ...
        public void draw(@NonNull Canvas canvas) {
            ...
            canvas.translate((((-this.mOffset) * ((float) width)) * this.mPosition) * ((float) flipRtl), AutoScrollHelper.RELATIVE_UNSPECIFIED);
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, boolean animate, @DrawableRes int drawerImageRes, @StringRes int openDrawerContentDescRes, @StringRes int closeDrawerContentDescRes) {
        ...
        this.mSlider.setOffset(animate ? TOGGLE_DRAWABLE_OFFSET : AutoScrollHelper.RELATIVE_UNSPECIFIED);
    }
    ...
    public void syncState() {
        if (this.mDrawerLayout.isDrawerOpen((int) GravityCompat.START)) {
            ...
            this.mSlider.setPosition(AutoScrollHelper.RELATIVE_UNSPECIFIED);
        }
    ...
    public void onDrawerSlide(View drawerView, float slideOffset) {
        ...
        if (slideOffset > 0.5f) {
            glyphOffset = Math.max(glyphOffset, Math.max(AutoScrollHelper.RELATIVE_UNSPECIFIED, slideOffset - 0.5f) * 2.0f);
        } else {
