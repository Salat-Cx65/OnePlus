...
public final class RemoteInput extends android.support.v4.app.RemoteInputCompatBase.RemoteInput {
    ...
    public static final class Builder {
        ...
        public android.support.v4.app.RemoteInput.Builder setAllowDataType(String mimeType, boolean doAllow) {
            if (doAllow) {
        ...
        public android.support.v4.app.RemoteInput.Builder setAllowFreeFormInput(boolean allowFreeFormTextInput) {
