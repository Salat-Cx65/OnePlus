...
class FragmentTransitionCompat21 {
    ...
    static class AnonymousClass_2 implements TransitionListener {
        final /* synthetic */ ArrayList val$exitingViews;
        final /* synthetic */ View val$fragmentView;

        AnonymousClass_2(View view, ArrayList arrayList) {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.val$fragmentView.setVisibility(DetectedActivity.RUNNING);
    ...
    static class AnonymousClass_3 implements Runnable {
        ...
        AnonymousClass_3(int i, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
    ...
    static class AnonymousClass_4 implements Runnable {
        ...
        AnonymousClass_4(ArrayList arrayList, Map map) {
            this.val$sharedElementsIn = arrayList;
    ...
    static class AnonymousClass_5 implements TransitionListener {
        ...
        AnonymousClass_5(Object obj, ArrayList arrayList, Object obj2, ArrayList arrayList2, Object obj3, ArrayList arrayList3) {
    ...
    static class AnonymousClass_6 extends EpicenterCallback {
        final /* synthetic */ Rect val$epicenter;

        AnonymousClass_6(Rect rect) {
            this.val$epicenter = rect;
        }
    ...
    static class AnonymousClass_7 implements Runnable {
        ...
        AnonymousClass_7(ArrayList arrayList, Map map) {
            this.val$sharedElementsIn = arrayList;
            this.val$nameOverrides = map;
        }
    ...
    public static Object cloneTransition(Object transition) {
        return transition != null ? ((Transition) transition).clone() : null;
    }
    ...
    public static void setEpicenter(Object transitionObj, View view) {
        if (view != null) {
            ...
            transition.setEpicenterCallback(new AnonymousClass_1(epicenter));
        }
    }
    ...
    public static void scheduleHideFragmentView(Object exitTransitionObj, View fragmentView, ArrayList<View> exitingViews) {
        ((Transition) exitTransitionObj).addListener(new AnonymousClass_2(fragmentView, exitingViews));
    }
    ...
    public static void setNameOverridesReordered(View sceneRoot, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, ArrayList<String> inNames, Map<String, String> nameOverrides) {
        ...
        OneShotPreDrawListener.add(sceneRoot, new AnonymousClass_3(numSharedElements, sharedElementsIn, inNames, sharedElementsOut, outNames));
    }
    ...
    public static void setNameOverridesOrdered(View sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        OneShotPreDrawListener.add(sceneRoot, new AnonymousClass_4(sharedElementsIn, nameOverrides));
    }
    ...
    public static void scheduleRemoveTargets(Object overallTransitionObj, Object enterTransition, ArrayList<View> enteringViews, Object exitTransition, ArrayList<View> exitingViews, Object sharedElementTransition, ArrayList<View> sharedElementsIn) {
        ((Transition) overallTransitionObj).addListener(new AnonymousClass_5(enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementsIn));
    }
    ...
    public static void setEpicenter(Object transitionObj, Rect epicenter) {
        if (transitionObj != null) {
            ((Transition) transitionObj).setEpicenterCallback(new AnonymousClass_6(epicenter));
        }
    }

    public static void scheduleNameReset(ViewGroup sceneRoot, ArrayList<View> sharedElementsIn, Map<String, String> nameOverrides) {
        OneShotPreDrawListener.add(sceneRoot, new AnonymousClass_7(sharedElementsIn, nameOverrides));
    }
}
