...
class LoaderManagerImpl extends LoaderManager {
    ...
    final class LoaderInfo implements OnLoadCompleteListener<Object>, OnLoadCanceledListener<Object> {
        ...
        public void onLoadCanceled(Loader<Object> loader) {
            if (DEBUG) {
                Log.v(TAG, "onLoadCanceled: " + this);
            }
            if (this.mDestroyed) {
                if (DEBUG) {
                    Log.v(TAG, "  Ignoring load canceled -- destroyed");
                }
                ...
                Log.v(TAG, "  Ignoring load canceled -- not active");
            }
        }
