...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        pframe.setVisibility(DetectedActivity.RUNNING);
        pframe.setGravity(ConnectionResult.SIGN_IN_FAILED);
        ...
        tv.setGravity(ConnectionResult.SIGN_IN_FAILED);
    ...
    private void setListShown(boolean shown, boolean animate) {
        ...
        if (this.mProgressContainer == null) {
            ...
            if (shown) {
                ...
                this.mProgressContainer.setVisibility(DetectedActivity.RUNNING);
            ...
            this.mListContainer.setVisibility(DetectedActivity.RUNNING);
        }
    }
        ...
        if (this.mList == null) {
            ...
            if (root instanceof ListView) {
                ...
                if (this.mStandardEmptyView == null) {
                    ...
                    this.mStandardEmptyView.setVisibility(DetectedActivity.RUNNING);
                }
