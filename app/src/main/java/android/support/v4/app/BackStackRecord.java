...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public void dump(String prefix, PrintWriter writer, boolean full) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int opNum = OP_NULL; opNum < numOps; opNum++) {
                String cmdStr;
        ...
        for (int opNum = OP_NULL; opNum < numOps; opNum++) {
            ...
            if (container != 0 && container != lastContainer) {
                ...
                for (int i = startIndex; i < endIndex; i++) {
                    ...
                    for (int thoseOpIndex = OP_NULL; thoseOpIndex < numThoseOps; thoseOpIndex++) {
    ...
    Fragment trackAddedFragmentsInPop(ArrayList<Fragment> added, Fragment oldPrimaryNav) {
        for (int opNum = OP_NULL; opNum < this.mOps.size(); opNum++) {
            Op op = (Op) this.mOps.get(opNum);
            switch (op.cmd) {
                case OP_ADD:
                case OP_ATTACH:
