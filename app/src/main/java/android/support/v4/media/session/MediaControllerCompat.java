...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements DeathRecipient {
        ...
        private class MessageHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                if (this.mRegistered) {
                    switch (msg.what) {
                        case MSG_EVENT:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onSessionEvent((String) msg.obj, msg.getData());
                        case MSG_UPDATE_PLAYBACK_STATE:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onPlaybackStateChanged((PlaybackStateCompat) msg.obj);
                        case MSG_UPDATE_METADATA:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onMetadataChanged((MediaMetadataCompat) msg.obj);
                        case MSG_UPDATE_VOLUME:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onAudioInfoChanged((PlaybackInfo) msg.obj);
                        case MSG_UPDATE_QUEUE:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onQueueChanged((List) msg.obj);
                        case MSG_UPDATE_QUEUE_TITLE:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onQueueTitleChanged((CharSequence) msg.obj);
                        case MSG_UPDATE_EXTRAS:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onExtrasChanged((Bundle) msg.obj);
                        case MSG_DESTROYED:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onSessionDestroyed();
                        case MSG_UPDATE_REPEAT_MODE:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onRepeatModeChanged(((Integer) msg.obj).intValue());
                        case MSG_UPDATE_SHUFFLE_MODE_DEPRECATED:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onShuffleModeChanged(((Boolean) msg.obj).booleanValue());
                        case MSG_UPDATE_CAPTIONING_ENABLED:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onCaptioningEnabledChanged(((Boolean) msg.obj).booleanValue());
                        case MSG_UPDATE_SHUFFLE_MODE:
                            android.support.v4.media.session.MediaControllerCompat.Callback.this.onShuffleModeChanged(((Integer) msg.obj).intValue());
                        default:
                            break;
                    }
                }
        ...
        private static class StubApi21 implements android.support.v4.media.session.MediaControllerCompatApi21.Callback {
            private final WeakReference<android.support.v4.media.session.MediaControllerCompat.Callback> mCallback;
            ...
            public void onSessionDestroyed() {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
        ...
        private static class StubCompat extends Stub {
            ...
            public void onSessionDestroyed() throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(DetectedActivity.RUNNING, null, null);
                }
            }
            ...
            public void onPlaybackStateChanged(PlaybackStateCompat state) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(RainSurfaceView.RAIN_LEVEL_SHOWER, state, null);
                }
            }
            ...
            public void onMetadataChanged(MediaMetadataCompat metadata) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(RainSurfaceView.RAIN_LEVEL_DOWNPOUR, metadata, null);
                }
            }
            ...
            public void onQueueChanged(List<QueueItem> queue) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER, queue, null);
                }
            }
            ...
            public void onQueueTitleChanged(CharSequence title) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(ConnectionResult.RESOLUTION_REQUIRED, title, null);
                }
            }
            ...
            public void onCaptioningEnabledChanged(boolean enabled) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(ConnectionResult.LICENSE_CHECK_FAILED, Boolean.valueOf(enabled), null);
                }
            }
            ...
            public void onRepeatModeChanged(int repeatMode) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(ConnectionResult.SERVICE_INVALID, Integer.valueOf(repeatMode), null);
                }
            }
            ...
            public void onShuffleModeChangedDeprecated(boolean enabled) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(ConnectionResult.DEVELOPER_ERROR, Boolean.valueOf(enabled), null);
                }
            }
            ...
            public void onShuffleModeChanged(int shuffleMode) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(WeatherCircleView.ARC_DIN, Integer.valueOf(shuffleMode), null);
                }
            }
            ...
            public void onExtrasChanged(Bundle extras) throws RemoteException {
                android.support.v4.media.session.MediaControllerCompat.Callback callback = (android.support.v4.media.session.MediaControllerCompat.Callback) this.mCallback.get();
                if (callback != null) {
                    callback.postToHandler(DetectedActivity.WALKING, extras, null);
                }
            }
            ...
            public void onVolumeInfoChanged(ParcelableVolumeInfo info) throws RemoteException {
                ...
                if (callback != null) {
                    ...
                    callback.postToHandler(RainSurfaceView.RAIN_LEVEL_RAINSTORM, pi, null);
                }
            }
        }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        private void requestExtraBinder() {
            sendCommand(COMMAND_GET_EXTRA_BINDER, null, new ExtraBinderRequestResultReceiver(this, new Handler()));
        }
    ...
    public static MediaControllerCompat getMediaController(@NonNull Activity activity) {
        ...
        if (activity instanceof SupportActivity) {
            ...
            try {
                mediaControllerCompat = new MediaControllerCompat((Context) activity, Token.fromToken(MediaControllerCompatApi21.getSessionToken(controllerObj)));
