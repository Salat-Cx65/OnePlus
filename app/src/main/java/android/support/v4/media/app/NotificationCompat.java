...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        public android.support.v4.media.app.NotificationCompat.MediaStyle setMediaSession(Token token) {
            this.mToken = token;
            return this;
        }
        ...
        public android.support.v4.media.app.NotificationCompat.MediaStyle setCancelButtonIntent(PendingIntent pendingIntent) {
        ...
        RemoteViews generateContentView() {
            ...
            if (this.mActionsToShowInCompact == null) {
                ...
                numActionsInCompact = Math.min(this.mActionsToShowInCompact.length, MAX_MEDIA_BUTTONS_IN_COMPACT);
            }
            ...
            if (this.mShowCancelButton) {
                view.setViewVisibility(R.id.end_padder, DetectedActivity.RUNNING);
                ...
                view.setViewVisibility(R.id.cancel_action, DetectedActivity.RUNNING);
            }
            return view;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            if (this.mShowCancelButton) {
                ...
                big.setViewVisibility(R.id.cancel_action, DetectedActivity.RUNNING);
            }
            return big;
        }
