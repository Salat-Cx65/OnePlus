...
public final class MediaDescriptionCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public android.support.v4.media.MediaDescriptionCompat.Builder setMediaId(@Nullable String mediaId) {
            this.mMediaId = mediaId;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setTitle(@Nullable CharSequence title) {
            this.mTitle = title;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setSubtitle(@Nullable CharSequence subtitle) {
            this.mSubtitle = subtitle;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setDescription(@Nullable CharSequence description) {
            this.mDescription = description;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setIconBitmap(@Nullable Bitmap icon) {
            this.mIcon = icon;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setIconUri(@Nullable Uri iconUri) {
            this.mIconUri = iconUri;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setExtras(@Nullable Bundle extras) {
            this.mExtras = extras;
            return this;
        }

        public android.support.v4.media.MediaDescriptionCompat.Builder setMediaUri(@Nullable Uri mediaUri) {
