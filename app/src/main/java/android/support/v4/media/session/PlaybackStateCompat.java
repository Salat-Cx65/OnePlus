...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final class Builder {
        ...
        public android.support.v4.media.session.PlaybackStateCompat.Builder addCustomAction(String action, String name, int icon) {
            return addCustomAction(new CustomAction(action, name, icon, null));
        }

        public android.support.v4.media.session.PlaybackStateCompat.Builder addCustomAction(CustomAction customAction) {
        ...
        public android.support.v4.media.session.PlaybackStateCompat.Builder setErrorMessage(CharSequence errorMessage) {
            this.mErrorMessage = errorMessage;
            return this;
        }

        public android.support.v4.media.session.PlaybackStateCompat.Builder setErrorMessage(int errorCode, CharSequence errorMessage) {
            this.mErrorCode = errorCode;
            this.mErrorMessage = errorMessage;
            return this;
        }

        public android.support.v4.media.session.PlaybackStateCompat.Builder setExtras(Bundle extras) {
            this.mExtras = extras;
            return this;
        }
    ...
    public static final class CustomAction implements Parcelable {
        ...
        public static final class Builder {
            ...
            public android.support.v4.media.session.PlaybackStateCompat.CustomAction.Builder setExtras(Bundle extras) {
                this.mExtras = extras;
                return this;
            }
        ...
        public static android.support.v4.media.session.PlaybackStateCompat.CustomAction fromCustomAction(Object customActionObj) {
            if (customActionObj == null || VERSION.SDK_INT < 21) {
                return null;
            }
            android.support.v4.media.session.PlaybackStateCompat.CustomAction customAction = new android.support.v4.media.session.PlaybackStateCompat.CustomAction(CustomAction.getAction(customActionObj), CustomAction.getName(customActionObj), CustomAction.getIcon(customActionObj), CustomAction.getExtras(customActionObj));
        ...
        static {
            CREATOR = new Creator<android.support.v4.media.session.PlaybackStateCompat.CustomAction>() {
                public android.support.v4.media.session.PlaybackStateCompat.CustomAction createFromParcel(Parcel p) {
    ...
    public static int toKeyCode(long action) {
        ...
        if (action == 16) {
            return R.styleable.AppCompatTheme_searchViewStyle;
        }
        if (action == 1) {
            return R.styleable.AppCompatTheme_ratingBarStyleIndicator;
        }
        if (action == 64) {
            return WeatherCircleView.START_ANGEL_90;
        }
        if (action == 8) {
            return R.styleable.AppCompatTheme_seekBarStyle;
        }
        return action == 512 ? R.styleable.AppCompatTheme_ratingBarStyle : STATE_NONE;
    }
