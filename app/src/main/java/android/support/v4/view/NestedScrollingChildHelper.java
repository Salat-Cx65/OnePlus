...
public class NestedScrollingChildHelper {
    ...
    public boolean dispatchNestedFling(float velocityX, float velocityY, boolean consumed) {
        ...
        return parent != null ? ViewParentCompat.onNestedFling(parent, this.mView, velocityX, velocityY, consumed) : false;
    }
    ...
    public boolean dispatchNestedPreFling(float velocityX, float velocityY) {
        ...
        ViewParent parent = getNestedScrollingParentForType(0);
        return parent != null ? ViewParentCompat.onNestedPreFling(parent, this.mView, velocityX, velocityY) : false;
    }
