...
public class ViewCompat {
    ...
    static class ViewCompatApi21Impl extends ViewCompatApi19Impl {
        ...
        class AnonymousClass_1 implements OnApplyWindowInsetsListener {
            ...
            AnonymousClass_1(OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        ...
        public void setOnApplyWindowInsetsListener(View view, OnApplyWindowInsetsListener listener) {
            if (listener == null) {
                ...
                view.setOnApplyWindowInsetsListener(new AnonymousClass_1(listener));
            }
        }
