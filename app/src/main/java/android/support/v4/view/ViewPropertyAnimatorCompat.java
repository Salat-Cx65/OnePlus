...
public final class ViewPropertyAnimatorCompat {
    ...
    class AnonymousClass_2 implements AnimatorUpdateListener {
        ...
        AnonymousClass_2(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener, View view) {
    ...
    static class ViewPropertyAnimatorListenerApi14 implements ViewPropertyAnimatorListener {
        ...
        public void onAnimationStart(View view) {
            ...
            if (this.mVpa.mOldLayerType > -1) {
                view.setLayerType(RainSurfaceView.RAIN_LEVEL_SHOWER, null);
            }
            ...
            ViewPropertyAnimatorListener listenerTag = view.getTag(LISTENER_TAG_ID);
    ...
    public ViewPropertyAnimatorCompat setUpdateListener(ViewPropertyAnimatorUpdateListener listener) {
        ...
        if (view != null && VERSION.SDK_INT >= 19) {
            ...
            if (listener != null) {
                wrapped = new AnonymousClass_2(listener, view);
            }
