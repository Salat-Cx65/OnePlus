...
public final class MenuItemCompat {
    ...
    static class AnonymousClass_1 implements android.view.MenuItem.OnActionExpandListener {
    ...
    public static MenuItem setOnActionExpandListener(MenuItem item, OnActionExpandListener listener) {
        return item.setOnActionExpandListener(new AnonymousClass_1(listener));
    }
