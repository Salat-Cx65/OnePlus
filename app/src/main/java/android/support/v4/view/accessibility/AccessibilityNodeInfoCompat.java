...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_SHOW_ON_SCREEN = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionShowOnScreen());
            ACTION_SCROLL_TO_POSITION = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionScrollToPosition());
            ACTION_SCROLL_UP = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionScrollUp());
            ACTION_SCROLL_LEFT = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionScrollLeft());
            ACTION_SCROLL_DOWN = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionScrollDown());
            ACTION_SCROLL_RIGHT = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionScrollRight());
            ACTION_CONTEXT_CLICK = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionContextClick());
            ACTION_SET_PROGRESS = new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.AccessibilityActionCompat(IMPL.getActionSetProgress());
        }
    ...
    public static class CollectionInfoCompat {
        ...
        public static android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat obtain(int rowCount, int columnCount, boolean hierarchical, int selectionMode) {
            return new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat(IMPL.obtainCollectionInfo(rowCount, columnCount, hierarchical, selectionMode));
        }
        ...
        public static android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat obtain(int rowCount, int columnCount, boolean hierarchical) {
            return new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionInfoCompat(IMPL.obtainCollectionInfo(rowCount, columnCount, hierarchical));
        }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading, boolean selected) {
            return new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat(IMPL.obtainCollectionItemInfo(rowIndex, rowSpan, columnIndex, columnSpan, heading, selected));
        }
        ...
        public static android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat obtain(int rowIndex, int rowSpan, int columnIndex, int columnSpan, boolean heading) {
            return new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.CollectionItemInfoCompat(IMPL.obtainCollectionItemInfo(rowIndex, rowSpan, columnIndex, columnSpan, heading));
        }
    ...
    public static class RangeInfoCompat {
        ...
        public static android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.RangeInfoCompat obtain(int type, float min, float max, float current) {
            return new android.support.v4.view.accessibility.AccessibilityNodeInfoCompat.RangeInfoCompat(IMPL.obtainRangeInfo(type, min, max, current));
        }
    ...
    public CollectionInfoCompat getCollectionInfo() {
        ...
        return info == null ? null : new CollectionInfoCompat(info);
    }
    ...
    public CollectionItemInfoCompat getCollectionItemInfo() {
        ...
        return info == null ? null : new CollectionItemInfoCompat(info);
    }

    public RangeInfoCompat getRangeInfo() {
        Object info = IMPL.getRangeInfo(this.mInfo);
        return info == null ? null : new RangeInfoCompat(info);
    }
