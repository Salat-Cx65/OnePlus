...
public class IconCompat {
    ...
    static Bitmap createLegacyIconFromAdaptiveIcon(Bitmap adaptiveIconBitmap) {
        ...
        paint.setColor(0);
        paint.setShadowLayer(blur, AutoScrollHelper.RELATIVE_UNSPECIFIED, 0.020833334f * ((float) size), 1023410176);
        canvas.drawCircle(center, center, radius, paint);
        paint.setShadowLayer(blur, AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, 503316480);
        canvas.drawCircle(center, center, radius, paint);
