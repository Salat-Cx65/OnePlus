...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    public void setCircular(boolean circular) {
        ...
        setCornerRadius(AutoScrollHelper.RELATIVE_UNSPECIFIED);
    }
    ...
    public int getOpacity() {
        ...
        return (bm == null || bm.hasAlpha() || this.mPaint.getAlpha() < 255 || isGreaterThanZero(this.mCornerRadius)) ? OpBoostFramework.REQUEST_FAILED_UNKNOWN_POLICY : -1;
    }
