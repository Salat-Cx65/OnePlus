...
final class SwipeProgressBar {
    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (!this.mRunning) {
                ...
                this.mClipRect.set(((float) cx) - clearRadius, AutoScrollHelper.RELATIVE_UNSPECIFIED, ((float) cx) + clearRadius, (float) height);
    ...
    private void drawCircle(Canvas canvas, float cx, float cy, int color, float pct) {
        ...
        canvas.drawCircle(AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED, cx, this.mPaint);
        canvas.restore();
    }
