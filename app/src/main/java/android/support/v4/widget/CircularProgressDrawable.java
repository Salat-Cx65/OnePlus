...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    class AnonymousClass_1 implements AnimatorUpdateListener {
        ...
        AnonymousClass_1(Ring ring) {
            this.val$ring = ring;
        }

        public void onAnimationUpdate(ValueAnimator animation) {
            float interpolatedTime = ((Float) animation.getAnimatedValue()).floatValue();
            CircularProgressDrawable.this.updateRingColor(interpolatedTime, this.val$ring);
            CircularProgressDrawable.this.applyTransformation(interpolatedTime, this.val$ring, false);
    ...
    class AnonymousClass_2 implements AnimatorListener {
        ...
        AnonymousClass_2(Ring ring) {
            this.val$ring = ring;
        }

        public void onAnimationStart(Animator animator) {
            CircularProgressDrawable.this.mRotationCount = AutoScrollHelper.RELATIVE_UNSPECIFIED;
        }
        ...
        public void onAnimationRepeat(Animator animator) {
            CircularProgressDrawable.this.applyTransformation(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, this.val$ring, true);
    ...
    private static class Ring {
        ...
        Ring() {
            ...
            this.mCirclePaint.setColor(LARGE);
        }
        ...
        void drawTriangle(Canvas c, float startAngle, float sweepAngle, RectF bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.moveTo(AutoScrollHelper.RELATIVE_UNSPECIFIED, AutoScrollHelper.RELATIVE_UNSPECIFIED);
                this.mArrow.lineTo(((float) this.mArrowWidth) * this.mArrowScale, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        ...
        void resetOriginals() {
            ...
            setStartTrim(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            setEndTrim(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            setRotation(AutoScrollHelper.RELATIVE_UNSPECIFIED);
        }
    }
    ...
    private void setupAnimators() {
        ...
        animator.addUpdateListener(new AnonymousClass_1(ring));
        animator.setRepeatCount(-1);
        animator.setRepeatMode(DEFAULT);
        animator.setInterpolator(LINEAR_INTERPOLATOR);
        animator.addListener(new AnonymousClass_2(ring));
