...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public CharSequence getTitleCondensed() {
        ...
        return (VERSION.SDK_INT >= 18 || ctitle == null || (ctitle instanceof String)) ? ctitle : ctitle.toString();
    }
    ...
    private Drawable applyIconTintIfNecessary(Drawable icon) {
        if (icon != null && this.mNeedToApplyIconTint) {
    ...
    boolean setVisibleInt(boolean shown) {
        int oldFlags = this.mFlags;
        this.mFlags = (shown ? 0 : HIDDEN) | (this.mFlags & -9);
