...
abstract class MenuPopup implements ShowableListMenu, MenuPresenter, OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        toMenuAdapter(outerAdapter).mAdapterMenu.performItemAction((MenuItem) outerAdapter.getItem(position), this, closeMenuOnSubMenuOpened() ? 0 : RainSurfaceView.RAIN_LEVEL_RAINSTORM);
    }
