...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            ...
            this.mRunShowSoftInputIfNecessary = new Runnable() {
                public void run() {
                    android.support.v7.widget.SearchView.SearchAutoComplete.this.showSoftInputIfNecessary();
                }
            };
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (widthDp < 960 || heightDp < 720 || config.orientation != 2) {
                return (widthDp >= 600 || (widthDp >= 640 && heightDp >= 480)) ? 192 : 160;
            } else {
    ...
    public void setQueryRefinementEnabled(boolean enable) {
        ...
        if (this.mSuggestionsAdapter instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) this.mSuggestionsAdapter).setQueryRefinement(enable ? RainSurfaceView.RAIN_LEVEL_SHOWER : 1);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(width, CitySearchProvider.GET_SEARCH_RESULT_SUCC), MeasureSpec.makeMeasureSpec(height, CitySearchProvider.GET_SEARCH_RESULT_SUCC));
    }
    ...
    private void updateViewsVisibility(boolean collapsed) {
        ...
        int iconVisibility = (this.mCollapsedIcon.getDrawable() == null || this.mIconifiedByDefault) ? DetectedActivity.RUNNING : 0;
    ...
    private boolean hasVoiceSearch() {
        ...
        return (testIntent == null || getContext().getPackageManager().resolveActivity(testIntent, AccessibilityNodeInfoCompat.ACTION_CUT) == null) ? DBG : true;
    }
    ...
    private void updateSubmitButton(boolean hasText) {
        int visibility = DetectedActivity.RUNNING;
    ...
    private CharSequence getDecoratedHint(CharSequence hintText) {
        ...
        ssb.setSpan(new ImageSpan(this.mSearchHintIcon), 1, RainSurfaceView.RAIN_LEVEL_SHOWER, net.oneplus.weather.R.styleable.OneplusTheme_op_borderWidth);
        ssb.append(hintText);
        return ssb;
    }
    ...
    private void updateVoiceButton(boolean empty) {
        ...
        if (this.mVoiceButtonEnabled && !isIconified() && empty) {
            visibility = 0;
            this.mGoButton.setVisibility(DetectedActivity.RUNNING);
        }
    ...
    void onCloseClicked() {
        if (!TextUtils.isEmpty(this.mSearchSrcTextView.getText())) {
            this.mSearchSrcTextView.setText(StringUtils.EMPTY_STRING);
    ...
    public void onActionViewCollapsed() {
        setQuery(StringUtils.EMPTY_STRING, DBG);
        clearFocus();
        updateViewsVisibility(true);
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, CitySearchProvider.GET_SEARCH_RESULT_SUCC);
