...
class AppCompatPopupWindow extends PopupWindow {
    ...
    static class AnonymousClass_1 implements OnScrollChangedListener {
        ...
        AnonymousClass_1(Field field, PopupWindow popupWindow, OnScrollChangedListener onScrollChangedListener) {
    ...
    private static void wrapOnScrollChangedListener(PopupWindow popup) {
        try {
            ...
            fieldListener.set(popup, new AnonymousClass_1(fieldAnchor, popup, (OnScrollChangedListener) fieldListener.get(popup)));
        } catch (Exception e) {
