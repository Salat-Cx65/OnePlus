...
public abstract class SnapHelper extends OnFlingListener {
    ...
    public int[] calculateScrollDistance(int velocityX, int velocityY) {
        outDist = new int[2];
        this.mGravityScroller.fling(0, 0, velocityX, velocityY, CitySearchProvider.GET_SEARCH_RESULT_FAIL, Preference.DEFAULT_ORDER, Integer.MIN_VALUE, Integer.MAX_VALUE);
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        return !(layoutManager instanceof ScrollVectorProvider) ? null : new AnonymousClass_2(this.mRecyclerView.getContext());
    }
}
