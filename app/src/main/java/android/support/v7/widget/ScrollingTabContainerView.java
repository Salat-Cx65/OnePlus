...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, CitySearchProvider.GET_SEARCH_RESULT_SUCC), heightMeasureSpec);
            }
        }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(this.mContentHeight, CitySearchProvider.GET_SEARCH_RESULT_SUCC);
    ...
    private LinearLayoutCompat createTabLayout() {
        ...
        tabLayout.setGravity(ConnectionResult.SIGN_IN_FAILED);
    ...
    public void animateToVisibility(int visibility) {
        ...
        if (visibility == 0) {
            if (getVisibility() != 0) {
                setAlpha(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            }
            ViewPropertyAnimator anim = animate().alpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        ...
        anim = animate().alpha(AutoScrollHelper.RELATIVE_UNSPECIFIED);
        anim.setDuration(200);
        anim.setInterpolator(sAlphaInterpolator);
        anim.setListener(this.mVisAnimListener.withFinalVisibility(anim, visibility));
        anim.start();
    ...
    public void animateToTab(int position) {
        ...
        this.mTabSelector = new AnonymousClass_1(tabView);
