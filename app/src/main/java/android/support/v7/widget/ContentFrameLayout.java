    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == Integer.MIN_VALUE) {
            ...
            if (!(tvw == null || tvw.type == 0)) {
                ...
                if (w > 0) {
                    widthMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(w - (this.mDecorPadding.left + this.mDecorPadding.right), MeasureSpec.getSize(widthMeasureSpec)), CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                    fixedWidth = true;
                }
            }
        }
        if (heightMode == Integer.MIN_VALUE) {
            ...
            if (!(tvh == null || tvh.type == 0)) {
                ...
                if (h > 0) {
                    heightMeasureSpec = MeasureSpec.makeMeasureSpec(Math.min(h - (this.mDecorPadding.top + this.mDecorPadding.bottom), MeasureSpec.getSize(heightMeasureSpec)), CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                }
            }
        }
