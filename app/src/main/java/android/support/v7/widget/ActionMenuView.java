...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    public static class LayoutParams extends android.support.v7.widget.LinearLayoutCompat.LayoutParams {
        ...
        public LayoutParams(android.support.v7.widget.ActionMenuView.LayoutParams other) {
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < childCount; i++) {
            ...
            if (child.getVisibility() != 8) {
                ...
                lp.leftMargin = 0;
                lp.rightMargin = 0;
                boolean z = (isGeneratedItem && ((ActionMenuItemView) child).hasText()) ? 1 : null;
        ...
        while (expandableItemCount > 0 && cellsRemaining > 0) {
            int minCells = Preference.DEFAULT_ORDER;
            long minCellsAt = 0;
    ...
    static int measureChildForCells(View child, int cellSize, int cellsRemaining, int parentHeightMeasureSpec, int parentHeightPadding) {
        ...
        int cellsUsed = 0;
        if (cellsRemaining > 0) {
            if (!hasText || cellsRemaining >= 2) {
                child.measure(MeasureSpec.makeMeasureSpec(cellSize * cellsRemaining, CitySearchProvider.GET_SEARCH_RESULT_FAIL), childHeightSpec);
                ...
                if (hasText && cellsUsed < 2) {
                    cellsUsed = RainSurfaceView.RAIN_LEVEL_SHOWER;
                }
            }
        }
        ...
        child.measure(MeasureSpec.makeMeasureSpec(cellsUsed * cellSize, CitySearchProvider.GET_SEARCH_RESULT_SUCC), childHeightSpec);
        return cellsUsed;
    }
    ...
    protected boolean hasSupportDividerBeforeChildAt(int childIndex) {
        ...
        return (childIndex <= 0 || !(child instanceof ActionMenuChildView)) ? result : result | ((ActionMenuChildView) child).needsDividerBefore();
    }
