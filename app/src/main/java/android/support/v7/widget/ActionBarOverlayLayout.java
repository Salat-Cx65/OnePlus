...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mRemoveActionBarHideOffset = new Runnable() {
            public void run() {
                ...
                ActionBarOverlayLayout.this.mCurrentActionBarTopAnimator = ActionBarOverlayLayout.this.mActionBarTop.animate().translationY(AutoScrollHelper.RELATIVE_UNSPECIFIED).setListener(ActionBarOverlayLayout.this.mTopAnimatorListener);
            }
        };
    ...
    protected boolean fitSystemWindows(Rect insets) {
        ...
        boolean applyInsets = applyInsets(this.mActionBarTop, systemInsets, true, true, false, true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        lp = this.mContent.getLayoutParams();
    ...
    public boolean onStartNestedScroll(View child, View target, int axes) {
        return ((axes & 2) == 0 || this.mActionBarTop.getVisibility() != 0) ? false : this.mHideOnContentScroll;
    }
    ...
    private boolean shouldHideActionBarOnFling(float velocityX, float velocityY) {
        this.mFlingEstimator.fling(0, 0, 0, (int) velocityY, 0, 0, CitySearchProvider.GET_SEARCH_RESULT_FAIL, Preference.DEFAULT_ORDER);
