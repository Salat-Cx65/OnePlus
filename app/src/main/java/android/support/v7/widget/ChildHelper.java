...
class ChildHelper {
    ...
    static class Bucket {
        ...
        boolean get(int index) {
            if (index < 64) {
                return (this.mData & (1 << index)) != 0 ? true : DEBUG;
            } else {
                ensureNext();
        ...
        void insert(int index, boolean value) {
            ...
            boolean lastBit = (this.mData & Long.MIN_VALUE) != 0 ? true : DEBUG;
            long mask = (1 << index) - 1;
        ...
        boolean remove(int index) {
            ...
            long mask = 1 << index;
            boolean z = (this.mData & mask) != 0 ? true : DEBUG;
            this.mData &= -1 ^ mask;
            mask--;
            ...
            if (this.mNext.get(0)) {
                set(R.styleable.AppCompatTheme_dropDownListViewStyle);
            }
            this.mNext.remove(0);
            return z;
        }
        ...
        int countOnesBefore(int index) {
            return this.mNext == null ? index >= 64 ? Long.bitCount(this.mData) : Long.bitCount(this.mData & ((1 << index) - 1)) : index < 64 ? Long.bitCount(this.mData & ((1 << index) - 1)) : this.mNext.countOnesBefore(index - 64) + Long.bitCount(this.mData);
        }
    ...
    int indexOfChild(View child) {
        ...
        return (index == -1 || this.mBucket.get(index)) ? -1 : index - this.mBucket.countOnesBefore(index);
    }
