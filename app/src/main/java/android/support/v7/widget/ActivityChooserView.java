...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getItemViewType(int position) {
            return (this.mShowFooterView && position == getCount() - 1) ? ITEM_VIEW_TYPE_FOOTER : ITEM_VIEW_TYPE_ACTIVITY;
        }
        ...
        public int getCount() {
            ...
            return this.mShowFooterView ? count + 1 : count;
        }
        ...
        public int measureContentWidth() {
            ...
            int count = getCount();
            for (int i = ITEM_VIEW_TYPE_ACTIVITY; i < count; i++) {
    ...
    class AnonymousClass_4 extends ForwardingListener {
        AnonymousClass_4(View src) {
            super(src);
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mInitialActivityCount = attributesArray.getInt(R.styleable.ActivityChooserView_initialActivityCount, RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        ...
        expandButton.setOnTouchListener(new AnonymousClass_4(expandButton));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec), CitySearchProvider.GET_SEARCH_RESULT_SUCC);
        }
    ...
    void updateAppearance() {
        ...
        if (activityCount == 1 || (activityCount > 1 && historySize > 0)) {
            ...
            this.mDefaultActivityButton.setVisibility(DetectedActivity.RUNNING);
        }
        if (this.mDefaultActivityButton.getVisibility() == 0) {
