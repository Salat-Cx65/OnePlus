...
class SuggestionsAdapter extends ResourceCursorAdapter implements OnClickListener {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence constraint) {
        String query = constraint == null ? StringUtils.EMPTY_STRING : constraint.toString();
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (views.mIcon1 != null) {
            setViewDrawable(views.mIcon1, getIcon1(cursor), RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        }
        if (views.mIcon2 != null) {
            setViewDrawable(views.mIcon2, getIcon2(cursor), DetectedActivity.RUNNING);
        }
        ...
        views.mIconRefine.setVisibility(DetectedActivity.RUNNING);
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        ...
        text.setSpan(new TextAppearanceSpan(null, 0, 0, this.mUrlColor, null), 0, url.length(), net.oneplus.weather.R.styleable.OneplusTheme_op_borderWidth);
        return text;
    }
    ...
    private void setViewText(TextView v, CharSequence text) {
        ...
        if (TextUtils.isEmpty(text)) {
            v.setVisibility(DetectedActivity.RUNNING);
        } else {
            v.setVisibility(0);
        }
    }
    ...
    Cursor getSearchManagerSuggestions(SearchableInfo searchable, String query, int limit) {
        ...
        Builder uriBuilder = new Builder().scheme("content").authority(authority).query(StringUtils.EMPTY_STRING).fragment(StringUtils.EMPTY_STRING);
