...
public class ListPopupWindow implements ShowableListMenu {
    ...
    private class ResizePopupRunnable implements Runnable {
        ...
        public void run() {
            if (ListPopupWindow.this.mDropDownList != null && ViewCompat.isAttachedToWindow(ListPopupWindow.this.mDropDownList) && ListPopupWindow.this.mDropDownList.getCount() > ListPopupWindow.this.mDropDownList.getChildCount() && ListPopupWindow.this.mDropDownList.getChildCount() <= ListPopupWindow.this.mListItemExpandMaximum) {
                ListPopupWindow.this.mPopup.setInputMethodMode(INPUT_METHOD_NOT_NEEDED);
                ListPopupWindow.this.show();
            }
        }
    }
    ...
    public boolean onKeyDown(int keyCode, @NonNull KeyEvent event) {
        if (isShowing() && keyCode != 62) {
            if (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode)) {
                ...
                int firstItem = Preference.DEFAULT_ORDER;
                int lastItem = CitySearchProvider.GET_SEARCH_RESULT_FAIL;
                if (adapter != null) {
    ...
    public OnTouchListener createDragToOpenListener(View src) {
        return new AnonymousClass_1(src);
    }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
                ...
                public void onItemSelected(AdapterView<?> adapterView, View view, int position, long id) {
                    if (position != -1) {
                        ...
                        if (dropDownList != null) {
                            dropDownList.setListSelectionHidden(DEBUG);
                        }
                    }
                }
            ...
            if (hintView != null) {
                ...
                if (this.mDropDownWidth >= 0) {
                    widthMode = CitySearchProvider.GET_SEARCH_RESULT_FAIL;
        ...
        switch (this.mDropDownWidth) {
            case WRAP_CONTENT:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), CitySearchProvider.GET_SEARCH_RESULT_FAIL);
                break;
            case MATCH_PARENT:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                break;
            default:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mDropDownWidth, CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                break;
        }
