...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
    ...
    static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public boolean hasObservers() {
            return !this.mObservers.isEmpty() ? true : VERBOSE_TRACING;
        }
    ...
    public static abstract class ItemAnimator {
        ...
        public static class ItemHolderInfo {
            ...
            public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo setFrom(ViewHolder holder) {
                return setFrom(holder, TOUCH_SLOP_DEFAULT);
            }

            public android.support.v7.widget.RecyclerView.ItemAnimator.ItemHolderInfo setFrom(ViewHolder holder, int flags) {
    ...
    public static abstract class LayoutManager {
        ...
        public LayoutManager() {
            this.mHorizontalBoundCheckCallback = new Callback() {
                public int getChildCount() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getChildCount();
                }

                public View getParent() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.mRecyclerView;
                }

                public View getChildAt(int index) {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getChildAt(index);
                }

                public int getParentStart() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getPaddingLeft();
                }

                public int getParentEnd() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getWidth() - android.support.v7.widget.RecyclerView.LayoutManager.this.getPaddingRight();
                }

                public int getChildStart(View view) {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getDecoratedLeft(view) - ((LayoutParams) view.getLayoutParams()).leftMargin;
                }

                public int getChildEnd(View view) {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getDecoratedRight(view) + ((LayoutParams) view.getLayoutParams()).rightMargin;
                }
            };
            this.mVerticalBoundCheckCallback = new Callback() {
                public int getChildCount() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getChildCount();
                }
                ...
                public int getParentStart() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getPaddingTop();
                }

                public int getParentEnd() {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getHeight() - android.support.v7.widget.RecyclerView.LayoutManager.this.getPaddingBottom();
                }

                public int getChildStart(View view) {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getDecoratedTop(view) - ((LayoutParams) view.getLayoutParams()).topMargin;
                }

                public int getChildEnd(View view) {
                    return android.support.v7.widget.RecyclerView.LayoutManager.this.getDecoratedBottom(view) + ((LayoutParams) view.getLayoutParams()).bottomMargin;
                }
            };
        ...
        void setMeasuredDimensionFromChildren(int widthSpec, int heightSpec) {
            ...
            int maxX = CitySearchProvider.GET_SEARCH_RESULT_FAIL;
            int maxY = CitySearchProvider.GET_SEARCH_RESULT_FAIL;
            for (int i = TOUCH_SLOP_DEFAULT; i < count; i++) {
        ...
        public boolean removeCallbacks(Runnable action) {
            return this.mRecyclerView != null ? this.mRecyclerView.removeCallbacks(action) : VERBOSE_TRACING;
        }
        ...
        public boolean getClipToPadding() {
            return (this.mRecyclerView == null || !this.mRecyclerView.mClipToPadding) ? VERBOSE_TRACING : true;
        }
        ...
        public boolean checkLayoutParams(LayoutParams lp) {
            return lp != null ? true : VERBOSE_TRACING;
        }
        ...
        public boolean isSmoothScrolling() {
            return (this.mSmoothScroller == null || !this.mSmoothScroller.isRunning()) ? VERBOSE_TRACING : true;
        }
        ...
        public void addView(View child, int index) {
            addViewInt(child, index, VERBOSE_TRACING);
        }
        ...
        private void addViewInt(View child, int index, boolean disappearing) {
            ...
            if (holder.wasReturnedFromScrap() || holder.isScrap()) {
                ...
                this.mChildHelper.attachViewToParent(child, index, child.getLayoutParams(), VERBOSE_TRACING);
                ...
                this.mChildHelper.addView(child, index, VERBOSE_TRACING);
        ...
        public void removeDetachedView(View child) {
            this.mRecyclerView.removeDetachedView(child, VERBOSE_TRACING);
        }
        ...
        public int getPaddingStart() {
            return this.mRecyclerView != null ? ViewCompat.getPaddingStart(this.mRecyclerView) : TOUCH_SLOP_DEFAULT;
        }

        public int getPaddingEnd() {
            return this.mRecyclerView != null ? ViewCompat.getPaddingEnd(this.mRecyclerView) : TOUCH_SLOP_DEFAULT;
        }

        public boolean isFocused() {
            return (this.mRecyclerView == null || !this.mRecyclerView.isFocused()) ? VERBOSE_TRACING : true;
        }

        public boolean hasFocus() {
            return (this.mRecyclerView == null || !this.mRecyclerView.hasFocus()) ? VERBOSE_TRACING : true;
        }
        ...
        void removeAndRecycleScrapInt(Recycler recycler) {
            ...
            for (int i = scrapCount - 1; i >= 0; i--) {
                ...
                if (!vh.shouldIgnore()) {
                    vh.setIsRecyclable(VERBOSE_TRACING);
                    if (vh.isTmpDetached()) {
                        this.mRecyclerView.removeDetachedView(scrap, VERBOSE_TRACING);
                    }
                    if (this.mRecyclerView.mItemAnimator != null) {
        ...
        boolean shouldReMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(child.getMeasuredWidth(), widthSpec, lp.width) && isMeasurementUpToDate(child.getMeasuredHeight(), heightSpec, lp.height)) ? VERBOSE_TRACING : true;
        }

        boolean shouldMeasureChild(View child, int widthSpec, int heightSpec, LayoutParams lp) {
            return (!child.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(child.getWidth(), widthSpec, lp.width) && isMeasurementUpToDate(child.getHeight(), heightSpec, lp.height)) ? VERBOSE_TRACING : true;
        }
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == Integer.MIN_VALUE || parentMode == 1073741824) ? CitySearchProvider.GET_SEARCH_RESULT_FAIL : TOUCH_SLOP_DEFAULT;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public void getTransformedBoundingBox(View child, boolean includeDecorInsets, Rect out) {
            if (includeDecorInsets) {
                ...
                out.set(TOUCH_SLOP_DEFAULT, TOUCH_SLOP_DEFAULT, child.getWidth(), child.getHeight());
            }
            if (this.mRecyclerView != null) {
        ...
        public boolean requestChildRectangleOnScreen(RecyclerView parent, View child, Rect rect, boolean immediate) {
            return requestChildRectangleOnScreen(parent, child, rect, immediate, VERBOSE_TRACING);
        }
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView parent, int dx, int dy) {
            ...
            return (bounds.left - dx >= parentRight || bounds.right - dx <= parentLeft || bounds.top - dy >= parentBottom || bounds.bottom - dy <= parentTop) ? VERBOSE_TRACING : true;
        }

        @Deprecated
        public boolean onRequestChildFocus(RecyclerView parent, View child, View focused) {
            return (isSmoothScrolling() || parent.isComputingLayout()) ? true : VERBOSE_TRACING;
        }
        ...
        public void onInitializeAccessibilityNodeInfo(Recycler recycler, State state, AccessibilityNodeInfoCompat info) {
            if (this.mRecyclerView.canScrollVertically(NO_POSITION) || this.mRecyclerView.canScrollHorizontally(NO_POSITION)) {
                info.addAction((int) CitySearchProvider.PROVIDER_YAHOO_WEATHER);
                info.setScrollable(true);
            }
            if (this.mRecyclerView.canScrollVertically(VERTICAL) || this.mRecyclerView.canScrollHorizontally(VERTICAL)) {
                info.addAction((int) CitySearchProvider.PROVIDER_WEATHER_CHINA);
                info.setScrollable(true);
            }
        ...
        public void onInitializeAccessibilityNodeInfoForItem(Recycler recycler, State state, View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setCollectionItemInfo(CollectionItemInfoCompat.obtain(rowIndexGuess, VERTICAL, columnIndexGuess, 1, VERBOSE_TRACING, false));
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            properties.spanCount = a.getInt(R.styleable.RecyclerView_spanCount, VERTICAL);
            properties.reverseLayout = a.getBoolean(R.styleable.RecyclerView_reverseLayout, VERBOSE_TRACING);
            properties.stackFromEnd = a.getBoolean(R.styleable.RecyclerView_stackFromEnd, VERBOSE_TRACING);
            a.recycle();
            return properties;
        }

        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), CitySearchProvider.GET_SEARCH_RESULT_SUCC), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), CitySearchProvider.GET_SEARCH_RESULT_SUCC));
        }
    ...
    public static class RecycledViewPool {
        ...
        boolean willCreateInTime(int viewType, long approxCurrentNs, long deadlineNs) {
            ...
            return (expectedDurationNs == 0 || approxCurrentNs + expectedDurationNs < deadlineNs) ? true : VERBOSE_TRACING;
        }
    ...
    public final class Recycler {
        ...
        void updateViewCacheSize() {
            this.mViewCacheMax = this.mRequestedCacheMax + (RecyclerView.this.mLayout != null ? RecyclerView.this.mLayout.mPrefetchMaxCountObserved : TOUCH_SLOP_DEFAULT);
        ...
        public void bindViewToPosition(View view, int position) {
            ...
            rvLayoutParams.mPendingInvalidate = holder.itemView.getParent() == null ? true : VERBOSE_TRACING;
        }
        ...
        public View getViewForPosition(int position) {
            return getViewForPosition(position, VERBOSE_TRACING);
        }
        ...
        ViewHolder tryGetViewHolderForPositionByDeadline(int position, boolean dryRun, long deadlineNs) {
            ...
            if (RecyclerView.this.mState.isPreLayout()) {
                ...
                z = holder != null ? true : VERBOSE_TRACING;
            }
            if (holder == null) {
                ...
                if (holder != null) {
                    if (validateViewHolderForOffsetPosition(holder)) {
                        ...
                        if (!dryRun) {
                            ...
                            if (holder.isScrap()) {
                                RecyclerView.this.removeDetachedView(holder.itemView, VERBOSE_TRACING);
                                holder.unScrap();
            ...
            if (z && !RecyclerView.this.mState.isPreLayout() && holder.hasAnyOfTheFlags(CitySearchProvider.PROVIDER_YAHOO_WEATHER)) {
                holder.setFlags(TOUCH_SLOP_DEFAULT, CitySearchProvider.PROVIDER_YAHOO_WEATHER);
            ...
            rvLayoutParams.mViewHolder = holder;
            boolean z2 = (z && bound) ? true : VERBOSE_TRACING;
        ...
        private void attachAccessibilityDelegateOnBind(ViewHolder holder) {
            if (RecyclerView.this.isAccessibilityEnabled()) {
                ...
                if (ViewCompat.getImportantForAccessibility(itemView) == 0) {
                    ViewCompat.setImportantForAccessibility(itemView, VERTICAL);
                }
                if (!ViewCompat.hasAccessibilityDelegate(itemView)) {
                    holder.addFlags(AccessibilityNodeInfoCompat.ACTION_COPY);
        ...
        private void invalidateDisplayListInt(ViewHolder holder) {
            if (holder.itemView instanceof ViewGroup) {
                invalidateDisplayListInt((ViewGroup) holder.itemView, VERBOSE_TRACING);
            }
        }
        ...
        public void recycleView(View view) {
            ...
            if (holder.isTmpDetached()) {
                RecyclerView.this.removeDetachedView(view, VERBOSE_TRACING);
            }
            if (holder.isScrap()) {
                holder.unScrap();
            } else if (holder.wasReturnedFromScrap()) {
        ...
        void recycleViewHolderInternal(ViewHolder holder) {
            ...
            if (holder.isScrap() || holder.itemView.getParent() != null) {
                ...
                boolean cached = VERBOSE_TRACING;
                boolean recycled = VERBOSE_TRACING;
                if (forceRecycle || holder.isRecyclable()) {
                    if (this.mViewCacheMax > 0 && !holder.hasAnyOfTheFlags(526)) {
                        ...
                        if (ALLOW_THREAD_GAP_WORK && cachedViewSize > 0 && !RecyclerView.this.mPrefetchRegistry.lastPrefetchIncludedPosition(holder.mPosition)) {
        ...
        void addViewHolderToRecycledViewPool(ViewHolder holder, boolean dispatchRecycled) {
            ...
            if (holder.hasAnyOfTheFlags(AccessibilityNodeInfoCompat.ACTION_COPY)) {
                holder.setFlags(TOUCH_SLOP_DEFAULT, AccessibilityNodeInfoCompat.ACTION_COPY);
        ...
        void quickRecycleScrapView(View view) {
            ...
            holder.mInChangeScrap = VERBOSE_TRACING;
            holder.clearReturnedFromScrapFlag();
            recycleViewHolderInternal(holder);
        }
        ...
        void scrapView(View view) {
            ViewHolder holder = RecyclerView.getChildViewHolderInt(view);
            if (!holder.hasAnyOfTheFlags(WeatherCircleView.ARC_DIN) && holder.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(holder)) {
                ...
                holder.setScrapContainer(this, VERBOSE_TRACING);
            ...
            for (int i = TOUCH_SLOP_DEFAULT; i < cachedCount; i++) {
                ...
                if (holder != null && holder.mPosition >= start && holder.mPosition <= end) {
                    if (holder.mPosition == from) {
                        holder.offsetPosition(to - from, VERBOSE_TRACING);
                    } else {
                        holder.offsetPosition(inBetweenOffset, VERBOSE_TRACING);
                    }
                }
            }
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public static class Action {
            ...
            boolean hasJumpTarget() {
                return this.mJumpToPosition >= 0 ? true : VERBOSE_TRACING;
            }
    ...
    public static class State {
        ...
        public boolean hasTargetScrollPosition() {
            return this.mTargetPosition != -1 ? true : VERBOSE_TRACING;
        }
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            if (scroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.dispatchNestedPreScroll(dx, dy, scrollConsumed, null, VERTICAL)) {
                    dx -= scrollConsumed[0];
                    dy -= scrollConsumed[1];
                }
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    RecyclerView.this.resumeRequestLayout(VERBOSE_TRACING);
                ...
                if (!RecyclerView.this.dispatchNestedScroll(hresult, vresult, overscrollX, overscrollY, null, VERTICAL)) {
                ...
                boolean fullyConsumedVertical = (dy != 0 && RecyclerView.this.mLayout.canScrollVertically() && vresult == dy) ? true : VERBOSE_TRACING;
                boolean fullyConsumedHorizontal = (dx != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && hresult == dx) ? true : VERBOSE_TRACING;
                boolean fullyConsumedAny = ((dx == 0 && dy == 0) || fullyConsumedHorizontal || fullyConsumedVertical) ? true : VERBOSE_TRACING;
                if (scroller.isFinished() || !(fullyConsumedAny || RecyclerView.this.hasNestedScrollingParent(VERTICAL))) {
                    RecyclerView.this.setScrollState(TOUCH_SLOP_DEFAULT);
                    if (ALLOW_THREAD_GAP_WORK) {
                        RecyclerView.this.mPrefetchRegistry.clearPrefetchPositions();
                    }
                    RecyclerView.this.stopNestedScroll(VERTICAL);
                } else {
                    postOnAnimation();
            ...
            if (smoothScroller != null) {
                if (smoothScroller.isPendingInitialRun()) {
                    smoothScroller.onAnimation(TOUCH_SLOP_DEFAULT, TOUCH_SLOP_DEFAULT);
                }
        ...
        private int computeScrollDuration(int dx, int dy, int vx, int vy) {
            ...
            boolean horizontal = absDx > absDy ? true : VERBOSE_TRACING;
        ...
        public void smoothScrollBy(int dx, int dy, Interpolator interpolator) {
            int computeScrollDuration = computeScrollDuration(dx, dy, TOUCH_SLOP_DEFAULT, TOUCH_SLOP_DEFAULT);
    ...
    public static abstract class ViewHolder {
        ...
        boolean shouldIgnore() {
            return (this.mFlags & 128) != 0 ? true : VERBOSE_TRACING;
        }
        ...
        boolean isScrap() {
            return this.mScrapContainer != null ? true : VERBOSE_TRACING;
        }
        ...
        boolean wasReturnedFromScrap() {
            return (this.mFlags & 32) != 0 ? true : VERBOSE_TRACING;
        }
        ...
        boolean isInvalid() {
            return (this.mFlags & 4) != 0 ? true : VERBOSE_TRACING;
        }

        boolean needsUpdate() {
            return (this.mFlags & 2) != 0 ? true : VERBOSE_TRACING;
        }

        boolean isBound() {
            return (this.mFlags & 1) != 0 ? true : VERBOSE_TRACING;
        }

        boolean isRemoved() {
            return (this.mFlags & 8) != 0 ? true : VERBOSE_TRACING;
        }

        boolean hasAnyOfTheFlags(int flags) {
            return (this.mFlags & flags) != 0 ? true : VERBOSE_TRACING;
        }

        boolean isTmpDetached() {
            return (this.mFlags & 256) != 0 ? true : VERBOSE_TRACING;
        }

        boolean isAdapterPositionUnknown() {
            return ((this.mFlags & 512) != 0 || isInvalid()) ? true : VERBOSE_TRACING;
        }
        ...
        public final boolean isRecyclable() {
            return ((this.mFlags & 16) != 0 || ViewCompat.hasTransientState(this.itemView)) ? VERBOSE_TRACING : true;
        }

        private boolean shouldBeKeptAsChild() {
            return (this.mFlags & 16) != 0 ? true : VERBOSE_TRACING;
        }

        private boolean doesTransientStatePreventRecycling() {
            return ((this.mFlags & 16) == 0 && ViewCompat.hasTransientState(this.itemView)) ? true : VERBOSE_TRACING;
        }
    ...
    private class ItemAnimatorRestoreListener implements ItemAnimatorListener {
        ...
        public void onAnimationFinished(ViewHolder item) {
            ...
            if (!item.shouldBeKeptAsChild() && !RecyclerView.this.removeAnimatingView(item.itemView) && item.isTmpDetached()) {
                RecyclerView.this.removeDetachedView(item.itemView, VERBOSE_TRACING);
            }
        }
    }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        void copyFrom(android.support.v7.widget.RecyclerView.SavedState other) {
            this.mLayoutState = other.mLayoutState;
        }

        static {
            CREATOR = new ClassLoaderCreator<android.support.v7.widget.RecyclerView.SavedState>() {
                public android.support.v7.widget.RecyclerView.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                    return new android.support.v7.widget.RecyclerView.SavedState(in, loader);
                }

                public android.support.v7.widget.RecyclerView.SavedState createFromParcel(Parcel in) {
                    return new android.support.v7.widget.RecyclerView.SavedState(in, null);
                }

                public android.support.v7.widget.RecyclerView.SavedState[] newArray(int size) {
                    return new android.support.v7.widget.RecyclerView.SavedState[size];
                }
            };
        }
    }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        setWillNotDraw(getOverScrollMode() == 2 ? true : VERBOSE_TRACING);
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, R.styleable.RecyclerView, defStyle, TOUCH_SLOP_DEFAULT);
            String layoutManagerName = a.getString(R.styleable.RecyclerView_layoutManager);
            if (a.getInt(R.styleable.RecyclerView_android_descendantFocusability, NO_POSITION) == -1) {
                setDescendantFocusability(AccessibilityNodeInfoCompat.ACTION_EXPAND);
            }
            this.mEnableFastScroller = a.getBoolean(R.styleable.RecyclerView_fastScrollEnabled, VERBOSE_TRACING);
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new Callback() {
            ...
            public void offsetPositionsForRemovingLaidOutOrNewView(int positionStart, int itemCount) {
                RecyclerView.this.offsetPositionRecordsForRemove(positionStart, itemCount, VERBOSE_TRACING);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    private void addAnimatingView(ViewHolder viewHolder) {
        ...
        boolean alreadyParented = view.getParent() == this ? true : VERBOSE_TRACING;
    ...
    boolean removeAnimatingView(View view) {
        ...
        resumeRequestLayout(!removed ? true : VERBOSE_TRACING);
        return removed;
    }
    ...
    public ItemDecoration getItemDecorationAt(int index) {
        return (index < 0 || index >= this.mItemDecorations.size()) ? null : (ItemDecoration) this.mItemDecorations.get(index);
    }
    ...
    void consumePendingUpdateOperations() {
        if (!this.mFirstLayoutComplete || this.mDataSetHasChangedAfterLayout) {
            ...
            if (this.mAdapterHelper.hasAnyUpdateTypes(RainSurfaceView.RAIN_LEVEL_RAINSTORM) && !this.mAdapterHelper.hasAnyUpdateTypes(ConnectionResult.LICENSE_CHECK_FAILED)) {
    ...
    boolean scrollByInternal(int x, int y, MotionEvent ev) {
        ...
        if (dispatchNestedScroll(consumedX, consumedY, unconsumedX, unconsumedY, this.mScrollOffset, TOUCH_SLOP_DEFAULT)) {
        ...
        return (consumedX == 0 && consumedY == 0) ? VERBOSE_TRACING : true;
    }
    ...
    public boolean fling(int velocityX, int velocityY) {
        if (this.mLayout == null) {
            ...
            startNestedScroll(nestedScrollAxis, VERTICAL);
    ...
    private void pullGlows(float x, float overscrollX, float y, float overscrollY) {
        boolean invalidate = VERBOSE_TRACING;
        if (overscrollX < 0.0f) {
            ensureLeftGlow();
    ...
    private void releaseGlows() {
        boolean needsInvalidate = VERBOSE_TRACING;
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (canRunFocusFailure && (direction == 2 || direction == 1)) {
            int absDir;
            boolean needsFocusFailureLayout = VERBOSE_TRACING;
            if (this.mLayout.canScrollVertically()) {
                absDir = direction == 2 ? 130 : net.oneplus.weather.R.styleable.OneplusTheme_op_borderWidth;
            ...
            if (!needsFocusFailureLayout && this.mLayout.canScrollHorizontally()) {
                ...
                absDir = (i ^ rtl) != 0 ? net.oneplus.weather.R.styleable.AppCompatTheme_editTextColor : ConnectionResult.SIGN_IN_FAILED;
                if (ff.findNextFocus(this, focused, absDir) == null) {
                    needsFocusFailureLayout = true;
                } else {
                    needsFocusFailureLayout = false;
    ...
    private boolean isPreferredNextFocus(View focused, View next, int direction) {
        ...
        if (isPreferredNextFocusAbsolute(focused, next, (i ^ rtl) != 0 ? net.oneplus.weather.R.styleable.AppCompatTheme_editTextColor : ConnectionResult.SIGN_IN_FAILED)) {
            return true;
        }
        return direction == 2 ? isPreferredNextFocusAbsolute(focused, next, 130) : isPreferredNextFocusAbsolute(focused, next, net.oneplus.weather.R.styleable.OneplusTheme_op_borderWidth);
    }
    ...
    private boolean isPreferredNextFocusAbsolute(View focused, View next, int direction) {
        ...
        switch (direction) {
            ...
            case net.oneplus.weather.R.styleable.AppCompatTheme_editTextColor:
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        this.mTempRect.set(TOUCH_SLOP_DEFAULT, TOUCH_SLOP_DEFAULT, rectView.getWidth(), rectView.getHeight());
    ...
    protected boolean onRequestFocusInDescendants(int direction, Rect previouslyFocusedRect) {
        return isComputingLayout() ? VERBOSE_TRACING : super.onRequestFocusInDescendants(direction, previouslyFocusedRect);
    }
    ...
    void assertNotInLayoutOrScroll(String message) {
        if (isComputingLayout()) {
            ...
            Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(StringUtils.EMPTY_STRING + exceptionLabel()));
        }
    }
        ...
        if (dispatchOnItemTouchIntercept(e)) {
            ...
            switch (action) {
                case TOUCH_SLOP_DEFAULT:
                    ...
                    startNestedScroll(nestedScrollAxis, TOUCH_SLOP_DEFAULT);
                    break;
                case VERTICAL:
                    this.mVelocityTracker.clear();
                    stopNestedScroll(TOUCH_SLOP_DEFAULT);
                    break;
                case SCROLL_STATE_SETTLING:
            ...
            return this.mScrollState == 1 ? true : VERBOSE_TRACING;
        }
    }
    ...
    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean onTouchEvent(android.view.MotionEvent r22_e) {
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        if (!(this.mLayout == null || this.mLayoutFrozen || event.getAction() != 8)) {
            ...
            if ((event.getSource() & 2) != 0) {
                vScroll = this.mLayout.canScrollVertically() ? -event.getAxisValue(ConnectionResult.SERVICE_INVALID) : AutoScrollHelper.RELATIVE_UNSPECIFIED;
                hScroll = this.mLayout.canScrollHorizontally() ? event.getAxisValue(ConnectionResult.DEVELOPER_ERROR) : AutoScrollHelper.RELATIVE_UNSPECIFIED;
            } else if ((event.getSource() & 4194304) != 0) {
                float axisScroll = event.getAxisValue(net.oneplus.weather.R.styleable.Toolbar_titleMargins);
                if (this.mLayout.canScrollVertically()) {
                    vScroll = -axisScroll;
                    hScroll = AutoScrollHelper.RELATIVE_UNSPECIFIED;
                } else if (this.mLayout.canScrollHorizontally()) {
                    vScroll = AutoScrollHelper.RELATIVE_UNSPECIFIED;
                    hScroll = axisScroll;
                } else {
                    vScroll = AutoScrollHelper.RELATIVE_UNSPECIFIED;
                    hScroll = AutoScrollHelper.RELATIVE_UNSPECIFIED;
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        boolean skipMeasure = VERBOSE_TRACING;
        if (this.mLayout == null) {
            ...
            if (!skipMeasure && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), CitySearchProvider.GET_SEARCH_RESULT_SUCC), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), CitySearchProvider.GET_SEARCH_RESULT_SUCC));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(widthSpec, heightSpec);
                }
    ...
    private View findNextViewToFocus() {
        int startFocusSearchIndex = this.mState.mFocusedItemPosition != -1 ? this.mState.mFocusedItemPosition : TOUCH_SLOP_DEFAULT;
    ...
    private void dispatchLayoutStep1() {
        ...
        saveFocusInfo();
        State state = this.mState;
        boolean z = (this.mState.mRunSimpleAnimations && this.mItemsChanged) ? true : VERBOSE_TRACING;
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (i = TOUCH_SLOP_DEFAULT; i < this.mChildHelper.getChildCount(); i++) {
                ...
                if (!viewHolder.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(viewHolder)) {
                    ...
                    boolean wasHidden = viewHolder.hasAnyOfTheFlags(CitySearchProvider.PROVIDER_YAHOO_WEATHER);
                    if (!wasHidden) {
                        flags |= 4096;
                    }
    ...
    private void dispatchLayoutStep2() {
        ...
        eatRequestLayout();
        onEnterLayoutOrScroll();
        this.mState.assertLayoutStep(ConnectionResult.RESOLUTION_REQUIRED);
        this.mAdapterHelper.consumeUpdatesInOnePass();
        this.mState.mItemCount = this.mAdapter.getItemCount();
    ...
    private void dispatchLayoutStep3() {
        this.mState.assertLayoutStep(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        eatRequestLayout();
        onEnterLayoutOrScroll();
    ...
    void recordAnimationInfoIfBouncedHiddenView(ViewHolder viewHolder, ItemHolderInfo animationInfo) {
        viewHolder.setFlags(TOUCH_SLOP_DEFAULT, CitySearchProvider.PROVIDER_YAHOO_WEATHER);
    ...
    private boolean didChildRangeChange(int minPositionPreLayout, int maxPositionPreLayout) {
        findMinMaxChildLayoutPositions(this.mMinMaxLayoutPositions);
        return (this.mMinMaxLayoutPositions[0] == minPositionPreLayout && this.mMinMaxLayoutPositions[1] == maxPositionPreLayout) ? VERBOSE_TRACING : true;
    }
    ...
    void animateAppearance(@NonNull ViewHolder itemHolder, @Nullable ItemHolderInfo preLayoutInfo, @NonNull ItemHolderInfo postLayoutInfo) {
        itemHolder.setIsRecyclable(VERBOSE_TRACING);
    ...
    void animateDisappearance(@NonNull ViewHolder holder, @NonNull ItemHolderInfo preLayoutInfo, @Nullable ItemHolderInfo postLayoutInfo) {
        ...
        holder.setIsRecyclable(VERBOSE_TRACING);
    ...
    private void animateChange(@NonNull ViewHolder oldHolder, @NonNull ViewHolder newHolder, @NonNull ItemHolderInfo preInfo, @NonNull ItemHolderInfo postInfo, boolean oldHolderDisappearing, boolean newHolderDisappearing) {
        oldHolder.setIsRecyclable(VERBOSE_TRACING);
        ...
        if (oldHolder != newHolder) {
            ...
            newHolder.setIsRecyclable(VERBOSE_TRACING);
    ...
    protected boolean checkLayoutParams(android.view.ViewGroup.LayoutParams p) {
        return ((p instanceof LayoutParams) && this.mLayout.checkLayoutParams((LayoutParams) p)) ? true : VERBOSE_TRACING;
    }
    ...
    void offsetPositionRecordsForInsert(int positionStart, int itemCount) {
        ...
        for (int i = TOUCH_SLOP_DEFAULT; i < childCount; i++) {
            ...
            if (holder != null && !holder.shouldIgnore() && holder.mPosition >= positionStart) {
                holder.offsetPosition(itemCount, VERBOSE_TRACING);
                this.mState.mStructureChanged = true;
            }
        }
    ...
    public ViewHolder findViewHolderForPosition(int position) {
        return findViewHolderForPosition(position, VERBOSE_TRACING);
    }
