...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        ...
        boolean hasSubtitle;
        int i;
        int i2 = DetectedActivity.RUNNING;
    ...
    public void initForMode(ActionMode mode) {
        ...
        this.mClose.findViewById(R.id.action_mode_close_button).setOnClickListener(new AnonymousClass_1(mode));
        ...
        if (MeasureSpec.getMode(widthMeasureSpec) != 1073741824) {
            ...
            if (this.mTitleLayout != null && this.mCustomView == null) {
                if (this.mTitleOptional) {
                    ...
                    this.mTitleLayout.setVisibility(titleFits ? null : DetectedActivity.RUNNING);
                } else {
            ...
            if (this.mCustomView != null) {
                ...
                int customWidthMode = lp2.width != -2 ? CitySearchProvider.GET_SEARCH_RESULT_SUCC : CitySearchProvider.GET_SEARCH_RESULT_FAIL;
                if (lp2.width >= 0) {
                    customWidth = Math.min(lp2.width, availableWidth);
                } else {
                    customWidth = availableWidth;
                }
                int customHeightMode = lp2.height != -2 ? CitySearchProvider.GET_SEARCH_RESULT_SUCC : CitySearchProvider.GET_SEARCH_RESULT_FAIL;
                if (lp2.height >= 0) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (!(this.mClose == null || this.mClose.getVisibility() == 8)) {
            ...
            x = next(x + positionChild(this.mClose, x, y, contentHeight, isLayoutRtl), endMargin, isLayoutRtl);
        }
