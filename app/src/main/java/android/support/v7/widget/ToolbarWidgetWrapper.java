...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : AutoScrollHelper.RELATIVE_UNSPECIFIED).setDuration(duration).setListener(new AnonymousClass_2(visibility));
    }
