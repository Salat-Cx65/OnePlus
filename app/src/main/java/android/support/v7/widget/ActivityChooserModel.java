...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<android.support.v7.widget.ActivityChooserModel.ActivityResolveInfo> {
        ...
        public boolean equals(Object obj) {
            ...
            return Float.floatToIntBits(this.weight) == Float.floatToIntBits(((android.support.v7.widget.ActivityChooserModel.ActivityResolveInfo) obj).weight);
        }
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List<ActivityResolveInfo> activities, List<HistoricalRecord> historicalRecords) {
            ...
            float nextRecordWeight = DEFAULT_HISTORICAL_RECORD_WEIGHT;
    ...
    public void setDefaultActivity(int index) {
        synchronized (this.mInstanceLock) {
            ...
            addHistoricalRecord(new HistoricalRecord(new ComponentName(newDefaultActivity.resolveInfo.activityInfo.packageName, newDefaultActivity.resolveInfo.activityInfo.name), System.currentTimeMillis(), oldDefaultActivity != null ? (oldDefaultActivity.weight - newDefaultActivity.weight) + 5.0f : DEFAULT_HISTORICAL_RECORD_WEIGHT));
        }
    }
