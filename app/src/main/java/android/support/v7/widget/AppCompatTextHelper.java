        ...
        if (ap != -1) {
            ...
            if (VERSION.SDK_INT < 23) {
                ...
                if (a.hasValue(R.styleable.TextAppearance_android_textColorHint)) {
                    colorStateList2 = a.getColorStateList(R.styleable.TextAppearance_android_textColorHint);
                }
                if (a.hasValue(R.styleable.TextAppearance_android_textColorLink)) {
                    colorStateList3 = a.getColorStateList(R.styleable.TextAppearance_android_textColorLink);
                }
            }
            a.recycle();
        }
