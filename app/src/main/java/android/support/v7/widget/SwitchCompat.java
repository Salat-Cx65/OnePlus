...
public class SwitchCompat extends CompoundButton {
    ...
    static class AnonymousClass_1 extends Property<SwitchCompat, Float> {
    ...
    static {
        THUMB_POS = new AnonymousClass_1(Float.class, "thumbPos");
    ...
    public void setSwitchTypeface(Typeface tf, int style) {
        ...
        this.mTextPaint.setTextSkewX(AutoScrollHelper.RELATIVE_UNSPECIFIED);
        setSwitchTypeface(tf);
    }
            ...
            case TOUCH_MODE_DRAGGING:
                switch (this.mTouchMode) {
                    ...
                    case TOUCH_MODE_DRAGGING:
                        ...
                        float newPos = constrain(this.mThumbPosition + dPos, AutoScrollHelper.RELATIVE_UNSPECIFIED, DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        float targetPosition = newCheckedState ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : AutoScrollHelper.RELATIVE_UNSPECIFIED;
    ...
    public void setChecked(boolean checked) {
        ...
        if (getWindowToken() == null || !ViewCompat.isLaidOut(this)) {
            ...
            setThumbPosition(checked ? DefaultRetryPolicy.DEFAULT_BACKOFF_MULT : AutoScrollHelper.RELATIVE_UNSPECIFIED);
            return;
        }
    ...
    public int getCompoundPaddingLeft() {
        ...
        return !TextUtils.isEmpty(getText()) ? padding + this.mSwitchPadding : padding;
    }
