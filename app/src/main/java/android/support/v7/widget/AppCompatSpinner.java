...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    private static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public int getCount() {
            return this.mAdapter == null ? MODE_DIALOG : this.mAdapter.getCount();
        }
    ...
    class AnonymousClass_1 extends ForwardingListener {
        final /* synthetic */ DropdownPopup val$popup;

        AnonymousClass_1(View src, DropdownPopup dropdownPopup) {
    ...
    private class DropdownPopup extends ListPopupWindow {
        ...
        class AnonymousClass_1 implements OnItemClickListener {
            ...
            AnonymousClass_1(AppCompatSpinner appCompatSpinner) {
        ...
        class AnonymousClass_3 implements OnDismissListener {
            final /* synthetic */ OnGlobalLayoutListener val$layoutListener;

            AnonymousClass_3(OnGlobalLayoutListener onGlobalLayoutListener) {
        ...
        public DropdownPopup(Context context, AttributeSet attrs, int defStyleAttr) {
            ...
            setModal(true);
            setPromptPosition(MODE_DIALOG);
            setOnItemClickListener(new AnonymousClass_1(AppCompatSpinner.this));
        }
        ...
        public void show() {
            ...
            computeContentWidth();
            setInputMethodMode(RainSurfaceView.RAIN_LEVEL_SHOWER);
            super.show();
            ...
            if (!wasShowing) {
                ...
                if (vto != null) {
                    ...
                    setOnDismissListener(new AnonymousClass_3(layoutListener));
                }
            }
        }
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Theme popupTheme) {
        ...
        if (this.mPopupContext != null) {
            ...
            if (mode == 1) {
                ...
                this.mDropDownWidth = pa.getLayoutDimension(R.styleable.Spinner_android_dropDownWidth, (int) ListPopupWindow.WRAP_CONTENT);
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new AnonymousClass_1(this, popup);
            }
        }
    ...
    public int getDropDownVerticalOffset() {
        ...
        return VERSION.SDK_INT >= 16 ? super.getDropDownVerticalOffset() : MODE_DIALOG;
    }
    ...
    public int getDropDownHorizontalOffset() {
        ...
        return VERSION.SDK_INT >= 16 ? super.getDropDownHorizontalOffset() : MODE_DIALOG;
    }
    ...
    public int getDropDownWidth() {
        ...
        return VERSION.SDK_INT >= 16 ? super.getDropDownWidth() : MODE_DIALOG;
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        return (this.mForwardingListener == null || !this.mForwardingListener.onTouch(this, event)) ? super.onTouchEvent(event) : true;
    }
    ...
    int compatMeasureContentWidth(SpinnerAdapter adapter, Drawable background) {
        ...
        for (int i = Math.max(MODE_DIALOG, start - (15 - (end - start))); i < end; i++) {
