...
public class NotificationCompat extends android.support.v4.app.NotificationCompat {
    ...
    public static class MediaStyle extends android.support.v4.media.app.NotificationCompat.MediaStyle {
        ...
        public android.support.v7.app.NotificationCompat.MediaStyle setShowActionsInCompactView(int... actions) {
            return (android.support.v7.app.NotificationCompat.MediaStyle) super.setShowActionsInCompactView(actions);
        }

        @Deprecated
        public android.support.v7.app.NotificationCompat.MediaStyle setMediaSession(Token token) {
            return (android.support.v7.app.NotificationCompat.MediaStyle) super.setMediaSession(token);
        }

        @Deprecated
        public android.support.v7.app.NotificationCompat.MediaStyle setShowCancelButton(boolean show) {
            return (android.support.v7.app.NotificationCompat.MediaStyle) super.setShowCancelButton(show);
        }

        @Deprecated
        public android.support.v7.app.NotificationCompat.MediaStyle setCancelButtonIntent(PendingIntent pendingIntent) {
            return (android.support.v7.app.NotificationCompat.MediaStyle) super.setCancelButtonIntent(pendingIntent);
        }
    }
