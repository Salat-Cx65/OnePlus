...
public abstract class ActionBar {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(@NonNull Context c, AttributeSet attrs) {
            ...
            this.gravity = a.getInt(R.styleable.ActionBarLayout_android_layout_gravity, NAVIGATION_MODE_STANDARD);
            a.recycle();
        }
    ...
    public static abstract class Tab {
        ...
        public abstract android.support.v7.app.ActionBar.Tab setContentDescription(@StringRes int i);

        public abstract android.support.v7.app.ActionBar.Tab setContentDescription(CharSequence charSequence);

        public abstract android.support.v7.app.ActionBar.Tab setCustomView(int i);

        public abstract android.support.v7.app.ActionBar.Tab setCustomView(View view);

        public abstract android.support.v7.app.ActionBar.Tab setIcon(@DrawableRes int i);

        public abstract android.support.v7.app.ActionBar.Tab setIcon(Drawable drawable);

        public abstract android.support.v7.app.ActionBar.Tab setTabListener(TabListener tabListener);

        public abstract android.support.v7.app.ActionBar.Tab setTag(Object obj);

        public abstract android.support.v7.app.ActionBar.Tab setText(int i);

        public abstract android.support.v7.app.ActionBar.Tab setText(CharSequence charSequence);
    }
