...
class AlertController {
    ...
    class AnonymousClass_4 implements OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;
    ...
    class AnonymousClass_5 implements Runnable {
        ...
        AnonymousClass_5(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    public static class AlertParams {
        ...
        class AnonymousClass_1 extends ArrayAdapter<CharSequence> {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (android.support.v7.app.AlertController.AlertParams.this.mCheckedItems != null && android.support.v7.app.AlertController.AlertParams.this.mCheckedItems[position]) {
        ...
        class AnonymousClass_2 extends CursorAdapter {
            ...
            AnonymousClass_2(Context x0, Cursor x1, boolean x2, RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
                super(x0, x1, x2);
                Cursor cursor = getCursor();
                this.mLabelIndex = cursor.getColumnIndexOrThrow(android.support.v7.app.AlertController.AlertParams.this.mLabelColumn);
                this.mIsCheckedIndex = cursor.getColumnIndexOrThrow(android.support.v7.app.AlertController.AlertParams.this.mIsCheckedColumn);
            }
            ...
            public View newView(Context context, Cursor cursor, ViewGroup parent) {
                return android.support.v7.app.AlertController.AlertParams.this.mInflater.inflate(this.val$dialog.mMultiChoiceItemLayout, parent, false);
            }
        }
        ...
        class AnonymousClass_3 implements OnItemClickListener {
            ...
            AnonymousClass_3(AlertController alertController) {
                this.val$dialog = alertController;
            }

            public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                android.support.v7.app.AlertController.AlertParams.this.mOnClickListener.onClick(this.val$dialog.mDialog, position);
                if (!android.support.v7.app.AlertController.AlertParams.this.mIsSingleChoice) {
        ...
        class AnonymousClass_4 implements OnItemClickListener {
            ...
            AnonymousClass_4(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }

            public void onItemClick(AdapterView<?> adapterView, View v, int position, long id) {
                if (android.support.v7.app.AlertController.AlertParams.this.mCheckedItems != null) {
                    android.support.v7.app.AlertController.AlertParams.this.mCheckedItems[position] = this.val$listView.isItemChecked(position);
                }
                android.support.v7.app.AlertController.AlertParams.this.mOnCheckboxClickListener.onClick(this.val$dialog.mDialog, position, this.val$listView.isItemChecked(position));
            }
        }
    ...
    class AnonymousClass_2 implements OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;
    ...
    private void setupView() {
        ...
        if (!hasCustomPanel) {
            ...
            if (content != null) {
                setScrollIndicators(contentPanel, content, (hasTopPanel ? 1 : 0) | (hasButtonPanel ? RainSurfaceView.RAIN_LEVEL_SHOWER : 0), 3);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new AnonymousClass_2(top, bottom));
                this.mScrollView.post(new AnonymousClass_3(top, bottom));
            } else if (this.mListView != null) {
                this.mListView.setOnScrollListener(new AnonymousClass_4(top, bottom));
                this.mListView.post(new AnonymousClass_5(top, bottom));
            } else {
                if (top != null) {
