...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    static class AnonymousClass_1 implements UncaughtExceptionHandler {
        final /* synthetic */ UncaughtExceptionHandler val$defHandler;

        AnonymousClass_1(UncaughtExceptionHandler uncaughtExceptionHandler) {
        ...
        public void uncaughtException(Thread thread, Throwable thowable) {
            if (shouldWrapException(thowable)) {
                Throwable wrapped = new NotFoundException(thowable.getMessage() + EXCEPTION_HANDLER_MESSAGE_SUFFIX);
        ...
        private boolean shouldWrapException(Throwable throwable) {
            ...
            if (message != null) {
                return (message.contains("drawable") || message.contains("Drawable")) ? true : DEBUG;
            } else {
                return DEBUG;
            }
        }
    ...
    private class ActionBarDrawableToggleImpl implements Delegate {
        ...
        public boolean isNavigationVisible() {
            ...
            return (ab == null || (ab.getDisplayOptions() & 4) == 0) ? DEBUG : true;
        }
    ...
    class AppCompatWindowCallbackBase extends WindowCallbackWrapper {
        ...
        public boolean dispatchKeyEvent(KeyEvent event) {
            return (AppCompatDelegateImplBase.this.dispatchKeyEvent(event) || super.dispatchKeyEvent(event)) ? true : DEBUG;
        }

        public boolean dispatchKeyShortcutEvent(KeyEvent event) {
            return (super.dispatchKeyShortcutEvent(event) || AppCompatDelegateImplBase.this.onKeyShortcut(event.getKeyCode(), event)) ? true : DEBUG;
        }

        public boolean onCreatePanelMenu(int featureId, Menu menu) {
            return (featureId != 0 || (menu instanceof MenuBuilder)) ? super.onCreatePanelMenu(featureId, menu) : DEBUG;
        }
        ...
        public boolean onPreparePanel(int featureId, View view, Menu menu) {
            ...
            mb.setOverrideVisibleItems(DEBUG);
            return onPreparePanel;
        }
    ...
    static {
        ...
        if (SHOULD_INSTALL_EXCEPTION_HANDLER && !sInstalledExceptionHandler) {
            Thread.setDefaultUncaughtExceptionHandler(new AnonymousClass_1(Thread.getDefaultUncaughtExceptionHandler()));
