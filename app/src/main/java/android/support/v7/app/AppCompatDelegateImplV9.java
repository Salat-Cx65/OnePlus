...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, Factory2 {
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim = ViewCompat.animate(AppCompatDelegateImplV9.this.mActionModeView).alpha(AutoScrollHelper.RELATIVE_UNSPECIFIED);
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                    public void onAnimationEnd(View view) {
                        AppCompatDelegateImplV9.this.mActionModeView.setVisibility(DetectedActivity.RUNNING);
                        if (AppCompatDelegateImplV9.this.mActionModePopup != null) {
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() {
            public void run() {
                ...
                if ((AppCompatDelegateImplV9.this.mInvalidatePanelMenuFeatures & 4096) != 0) {
                    AppCompatDelegateImplV9.this.doInvalidatePanelMenu(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground);
                }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(R.styleable.AppCompatTheme_windowNoTitle, false)) {
                ...
                requestWindowFeature(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground);
            }
            if (a.getBoolean(R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(net.oneplus.weather.R.styleable.AppCompatTheme_windowActionBar);
            }
            if (a.getBoolean(R.styleable.AppCompatTheme_windowActionModeOverlay, false)) {
                requestWindowFeature(ConnectionResult.DEVELOPER_ERROR);
            }
            ...
            if (this.mWindowNoTitle) {
                if (this.mOverlayActionMode) {
                    subDecor = inflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    subDecor = inflater.inflate(R.layout.abc_screen_simple, null);
                }
                ...
                subDecor = inflater.inflate(R.layout.abc_dialog_title_material, null);
                ...
                subDecor = LayoutInflater.from(themedContext).inflate(R.layout.abc_screen_toolbar, null);
                this.mDecorContentParent = (DecorContentParent) subDecor.findViewById(R.id.decor_content_parent);
                this.mDecorContentParent.setWindowCallback(getWindowCallback());
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(net.oneplus.weather.R.styleable.AppCompatTheme_windowActionBar);
                }
                if (this.mFeatureProgress) {
                    this.mDecorContentParent.initFeature(RainSurfaceView.RAIN_LEVEL_SHOWER);
                }
                if (this.mFeatureIndeterminateProgress) {
                    this.mDecorContentParent.initFeature(RainSurfaceView.RAIN_LEVEL_THUNDERSHOWER);
                }
            }
            if (subDecor == null) {
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        switch (featureId) {
            ...
            case ConnectionResult.DEVELOPER_ERROR:
                ...
                return true;
            case net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case net.oneplus.weather.R.styleable.AppCompatTheme_windowActionBar:
                throwFeatureRequestIfSubDecorInstalled();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, RainSurfaceView.RAIN_LEVEL_SHOWER);
                    ...
                    this.mActionModePopup.setHeight(ListPopupWindow.WRAP_CONTENT);
                    this.mShowActionModePopup = new Runnable() {
                        public void run() {
                            AppCompatDelegateImplV9.this.mActionModePopup.showAtLocation(AppCompatDelegateImplV9.this.mActionModeView, net.oneplus.weather.R.styleable.AppCompatTheme_colorPrimary, 0, 0);
                            AppCompatDelegateImplV9.this.endOnGoingFadeAnimation();
                            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                                AppCompatDelegateImplV9.this.mActionModeView.setAlpha(AutoScrollHelper.RELATIVE_UNSPECIFIED);
                                ...
                                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                                    ...
                                    public void onAnimationEnd(View view) {
                                        AppCompatDelegateImplV9.this.mActionModeView.setAlpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                                        AppCompatDelegateImplV9.this.mFadeAnim.setListener(null);
                                        AppCompatDelegateImplV9.this.mFadeAnim = null;
                                    }
                                });
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        this.mActionModeView.setAlpha(AutoScrollHelper.RELATIVE_UNSPECIFIED);
                        ...
                        this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                            public void onAnimationStart(View view) {
                                AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
                                AppCompatDelegateImplV9.this.mActionModeView.sendAccessibilityEvent(ItemTouchHelper.END);
                        ...
                        this.mActionModeView.setAlpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                        this.mActionModeView.setVisibility(0);
                        this.mActionModeView.sendAccessibilityEvent(ItemTouchHelper.END);
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            ...
            case net.oneplus.weather.R.styleable.AppCompatTheme_popupMenuStyle:
        ...
        if (!st.isOpen && !isDestroyed()) {
            ...
            if (cb == null || cb.onMenuOpened(st.featureId, st.menu)) {
                ...
                if (wm != null && preparePanel(st, event)) {
                    int width = ListPopupWindow.WRAP_CONTENT;
                    LayoutParams lp;
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground, st.menu);
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.createdPanelView == null) {
            if (!(isActionBarMenu && (peekSupportActionBar() instanceof ToolbarActionBar))) {
    ...
    void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground, menu);
            }
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return net.oneplus.weather.R.styleable.AppCompatTheme_tooltipFrameBackground;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return net.oneplus.weather.R.styleable.AppCompatTheme_windowActionBar;
        }
    }
