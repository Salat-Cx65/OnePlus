...
class ToolbarActionBar extends ActionBar {
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.styleable.AppCompatTheme_tooltipFrameBackground, subMenu);
            return true;
        }
        ...
        public void onCloseMenu(MenuBuilder menu, boolean allMenusAreClosing) {
            if (!this.mClosingActionMenu) {
                ...
                if (ToolbarActionBar.this.mWindowCallback != null) {
                    ToolbarActionBar.this.mWindowCallback.onPanelClosed(R.styleable.AppCompatTheme_tooltipFrameBackground, menu);
                }
    ...
    private final class MenuBuilderCallback implements MenuBuilder.Callback {
        ...
        public void onMenuModeChange(MenuBuilder menu) {
            ...
            if (ToolbarActionBar.this.mDecorToolbar.isOverflowMenuShowing()) {
                ...
                ToolbarActionBar.this.mWindowCallback.onMenuOpened(R.styleable.AppCompatTheme_tooltipFrameBackground, menu);
            }
        }
    }
    ...
    public void hide() {
        this.mDecorToolbar.setVisibility(DetectedActivity.RUNNING);
    }
