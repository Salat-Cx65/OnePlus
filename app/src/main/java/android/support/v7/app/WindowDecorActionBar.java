...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            if (WindowDecorActionBar.this.mActionMode == this) {
                if (WindowDecorActionBar.checkShowingFlags(WindowDecorActionBar.this.mHiddenByApp, WindowDecorActionBar.this.mHiddenBySystem, $assertionsDisabled)) {
                ...
                this.mCallback = null;
                WindowDecorActionBar.this.animateToMode($assertionsDisabled);
                WindowDecorActionBar.this.mContextView.closeMode();
                WindowDecorActionBar.this.mDecorToolbar.getViewGroup().sendAccessibilityEvent(ItemTouchHelper.END);
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            return this.mCallback != null ? this.mCallback.onActionItemClicked(this, item) : $assertionsDisabled;
        }
        ...
        this.mHideListener = new ViewPropertyAnimatorListenerAdapter() {
            public void onAnimationEnd(View view) {
                if (WindowDecorActionBar.this.mContentAnimations && WindowDecorActionBar.this.mContentView != null) {
                    WindowDecorActionBar.this.mContentView.setTranslationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
                    WindowDecorActionBar.this.mContainerView.setTranslationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
                }
                WindowDecorActionBar.this.mContainerView.setVisibility(DetectedActivity.RUNNING);
                WindowDecorActionBar.this.mContainerView.setTransitioning($assertionsDisabled);
    ...
    private void setHasEmbeddedTabs(boolean hasEmbeddedTabs) {
        ...
        if (this.mTabScrollView != null) {
            if (isInTabMode) {
                ...
                this.mTabScrollView.setVisibility(DetectedActivity.RUNNING);
            }
        }
        ...
        if (this.mTabScrollView == null) {
            ...
            if (this.mHasEmbeddedTabs) {
                ...
                if (getNavigationMode() == 2) {
                    ...
                    tabScroller.setVisibility(DetectedActivity.RUNNING);
                }
    ...
    public void setDisplayShowHomeEnabled(boolean showHome) {
        setDisplayOptions(showHome ? 2 : 0, RainSurfaceView.RAIN_LEVEL_SHOWER);
    }

    public void setDisplayHomeAsUpEnabled(boolean showHomeAsUp) {
        setDisplayOptions(showHomeAsUp ? 4 : 0, RainSurfaceView.RAIN_LEVEL_RAINSTORM);
    }

    public void setDisplayShowTitleEnabled(boolean showTitle) {
        setDisplayOptions(showTitle ? 8 : 0, DetectedActivity.RUNNING);
    }

    public void setDisplayShowCustomEnabled(boolean showCustom) {
        setDisplayOptions(showCustom ? 16 : 0, ConnectionResult.API_UNAVAILABLE);
    }
    ...
    public ActionMode startActionMode(Callback callback) {
        ...
        animateToMode(true);
        this.mContextView.sendAccessibilityEvent(ItemTouchHelper.END);
        return mode;
    }
    ...
    static boolean checkShowingFlags(boolean hiddenByApp, boolean hiddenBySystem, boolean showingForMode) {
        ...
        return (hiddenByApp || hiddenBySystem) ? $assertionsDisabled : true;
    }
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            this.mContainerView.setTranslationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            ...
            ViewPropertyAnimatorCompat a = ViewCompat.animate(this.mContainerView).translationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            a.setUpdateListener(this.mUpdateListener);
            anim.play(a);
            if (this.mContentAnimations && this.mContentView != null) {
                this.mContentView.setTranslationY(startingY);
                anim.play(ViewCompat.animate(this.mContentView).translationY(AutoScrollHelper.RELATIVE_UNSPECIFIED));
            }
            ...
            this.mContainerView.setAlpha(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            this.mContainerView.setTranslationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            if (this.mContentAnimations && this.mContentView != null) {
                this.mContentView.setTranslationY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            }
    ...
    public void animateToMode(boolean toActionMode) {
        ...
        if (shouldAnimateContextView()) {
            ...
            if (toActionMode) {
                fadeOut = this.mDecorToolbar.setupAnimatorToVisibility(RainSurfaceView.RAIN_LEVEL_RAINSTORM, FADE_OUT_DURATION_MS);
                ...
                fadeOut = this.mContextView.setupAnimatorToVisibility(DetectedActivity.RUNNING, FADE_OUT_DURATION_MS);
            }
            ViewPropertyAnimatorCompatSet set = new ViewPropertyAnimatorCompatSet();
            set.playSequentially(fadeOut, fadeIn);
            set.start();
        } else if (toActionMode) {
            this.mDecorToolbar.setVisibility(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
            this.mContextView.setVisibility(0);
        } else {
            this.mDecorToolbar.setVisibility(0);
            this.mContextView.setVisibility(DetectedActivity.RUNNING);
        }
    }
    ...
    public boolean onKeyShortcut(int keyCode, KeyEvent event) {
        ...
        boolean z;
        if (KeyCharacterMap.load(event != null ? event.getDeviceId() : INVALID_POSITION).getKeyboardType() != 1) {
            z = true;
        } else {
            z = false;
        }
