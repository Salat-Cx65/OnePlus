...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback, SupportParentable, DelegateProvider {
    ...
    public final boolean onMenuItemSelected(int featureId, MenuItem item) {
        ...
        return (item.getItemId() != 16908332 || ab == null || (ab.getDisplayOptions() & 4) == 0) ? false : onSupportNavigateUp();
    }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        return performMenuItemShortcut(keyCode, event) ? true : super.onKeyDown(keyCode, event);
    }
