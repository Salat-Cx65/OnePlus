    ...
    public void setChecked(boolean checked) {
        ...
        if (this.mShiftingMode) {
            if (checked) {
                ...
                this.mLargeLabel.setScaleX(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
                this.mLargeLabel.setScaleY(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            } else {
                iconParams = (LayoutParams) this.mIcon.getLayoutParams();
                iconParams.gravity = 17;
                iconParams.topMargin = this.mDefaultMargin;
                this.mIcon.setLayoutParams(iconParams);
                this.mLargeLabel.setVisibility(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
                this.mLargeLabel.setScaleX(0.5f);
                this.mLargeLabel.setScaleY(0.5f);
            }
            this.mSmallLabel.setVisibility(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        } else if (checked) {
            iconParams = (LayoutParams) this.mIcon.getLayoutParams();
            iconParams.gravity = 49;
            ...
            this.mSmallLabel.setScaleX(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            this.mSmallLabel.setScaleY(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
        }
        refreshDrawableState();
    }
