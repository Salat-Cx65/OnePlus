...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = MeasureSpec.makeMeasureSpec(this.mItemHeight, CitySearchProvider.GET_SEARCH_RESULT_SUCC);
        int extra;
        int i2;
        int[] iArr;
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i], CitySearchProvider.GET_SEARCH_RESULT_SUCC), heightSpec);
    ...
    public void buildMenuView() {
        ...
        if (this.mButtons != null) {
            ...
            for (int i = 0; i < length; i++) {
                this.mItemPool.release(bottomNavigationItemViewArr[i]);
            }
        }
    ...
    private BottomNavigationItemView getNewItem() {
        ...
        return item == null ? new BottomNavigationItemView(getContext()) : item;
    }
