    ...
    private class NavigationMenuAdapter extends Adapter<ViewHolder> {
        ...
        public int getItemViewType(int position) {
            ...
            if (item instanceof NavigationMenuTextItem) {
                return ((NavigationMenuTextItem) item).getMenuItem().hasSubMenu() ? VIEW_TYPE_SUBHEADER : VIEW_TYPE_NORMAL;
            } else {
        ...
        private void prepareMenuItems() {
            if (!this.mUpdateSuspended) {
                ...
                for (int i = VIEW_TYPE_NORMAL; i < totalSize; i++) {
                    ...
                    if (item.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            for (int j = VIEW_TYPE_NORMAL; j < size; j++) {
        ...
        public Bundle createInstanceState() {
            ...
            for (int i = VIEW_TYPE_NORMAL; i < size; i++) {
        ...
        public void restoreInstanceState(Bundle state) {
            ...
            if (checkedItem != 0) {
                ...
                for (i = VIEW_TYPE_NORMAL; i < size; i++) {
