...
final class CollapsingTextHelper {
    ...
    void setCollapsedTextAppearance(int resId) {
        ...
        this.mCollapsedShadowDx = a.getFloat(R.styleable.TextAppearance_android_shadowDx, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        this.mCollapsedShadowDy = a.getFloat(R.styleable.TextAppearance_android_shadowDy, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        this.mCollapsedShadowRadius = a.getFloat(R.styleable.TextAppearance_android_shadowRadius, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        a.recycle();
    ...
    void setExpandedTextAppearance(int resId) {
        ...
        this.mExpandedShadowDx = a.getFloat(R.styleable.TextAppearance_android_shadowDx, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        this.mExpandedShadowDy = a.getFloat(R.styleable.TextAppearance_android_shadowDy, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        this.mExpandedShadowRadius = a.getFloat(R.styleable.TextAppearance_android_shadowRadius, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        a.recycle();
        if (VERSION.SDK_INT >= 16) {
    ...
    void setExpansionFraction(float fraction) {
        fraction = MathUtils.clamp(fraction, (float) AutoScrollHelper.RELATIVE_UNSPECIFIED, (float) DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
