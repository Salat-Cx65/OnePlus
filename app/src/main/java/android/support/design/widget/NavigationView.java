...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static {
            CREATOR = new ClassLoaderCreator<android.support.design.widget.NavigationView.SavedState>() {
                public android.support.design.widget.NavigationView.SavedState createFromParcel(Parcel in, ClassLoader loader) {
                    return new android.support.design.widget.NavigationView.SavedState(in, loader);
                }

                public android.support.design.widget.NavigationView.SavedState createFromParcel(Parcel in) {
                    return new android.support.design.widget.NavigationView.SavedState(in, null);
                }
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        switch (MeasureSpec.getMode(widthSpec)) {
            case CitySearchProvider.GET_SEARCH_RESULT_FAIL:
                widthSpec = MeasureSpec.makeMeasureSpec(Math.min(MeasureSpec.getSize(widthSpec), this.mMaxWidth), CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                break;
            case RainSurfaceView.RAIN_LEVEL_DRIZZLE:
                widthSpec = MeasureSpec.makeMeasureSpec(this.mMaxWidth, CitySearchProvider.GET_SEARCH_RESULT_SUCC);
                break;
        }
