...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MeasureSpec.getMode(widthMeasureSpec) == 1073741824 && TabLayout.this.mMode == 1 && TabLayout.this.mTabGravity == 1) {
                ...
                if (largestTabWidth > 0) {
                    ...
                    if (largestTabWidth * count <= getMeasuredWidth() - (TabLayout.this.dpToPx(FIXED_WRAP_GUTTER_MIN) * 2)) {
        ...
        void animateIndicatorToPosition(int position, int duration) {
            ...
            if (Math.abs(position - this.mSelectedPosition) <= 1) {
                ...
                int offset = TabLayout.this.dpToPx(MOTION_NON_ADJACENT_OFFSET);
    ...
    public static final class Tab {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setTag(@Nullable Object tag) {
            this.mTag = tag;
            return this;
        }
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setCustomView(@Nullable View view) {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setCustomView(@LayoutRes int resId) {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setIcon(@Nullable Drawable icon) {
            this.mIcon = icon;
            updateView();
            return this;
        }
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setIcon(@DrawableRes int resId) {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setText(@Nullable CharSequence text) {
            this.mText = text;
            updateView();
            return this;
        }
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setText(@StringRes int resId) {
            if (this.mParent != null) {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setContentDescription(@StringRes int resId) {
            if (this.mParent != null) {
        ...
        @NonNull
        public android.support.design.widget.TabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
    ...
    class TabView extends LinearLayout {
        ...
        public TabView(Context context) {
            ...
            setClickable(true);
            ViewCompat.setPointerIcon(this, PointerIconCompat.getSystemIcon(getContext(), GeofenceStatusCodes.GEOFENCE_TOO_MANY_PENDING_INTENTS));
        }
        ...
        public boolean performClick() {
            ...
            if (!handled) {
                playSoundEffect(MODE_SCROLLABLE);
            }
            this.mTab.select();
            return true;
        }
        ...
        public void onMeasure(int origWidthMeasureSpec, int origHeightMeasureSpec) {
            ...
            if (maxWidth <= 0 || (specWidthMode != 0 && specWidthSize <= maxWidth)) {
                ...
                widthMeasureSpec = MeasureSpec.makeMeasureSpec(TabLayout.this.mTabMaxWidth, CitySearchProvider.GET_SEARCH_RESULT_FAIL);
            }
            super.onMeasure(widthMeasureSpec, heightMeasureSpec);
            if (this.mTextView != null) {
                ...
                if (textSize != curTextSize || (curMaxLines >= 0 && maxLines != curMaxLines)) {
                    ...
                    if (updateTextView) {
                        this.mTextView.setTextSize(MODE_SCROLLABLE, textSize);
        ...
        final void update() {
            ...
            if (custom != null) {
                ...
                if (this.mTextView != null) {
                    this.mTextView.setVisibility(DEFAULT_GAP_TEXT_ICON);
                }
                if (this.mIconView != null) {
                    this.mIconView.setVisibility(DEFAULT_GAP_TEXT_ICON);
        ...
        private void updateTextAndIcon(@Nullable TextView textView, @Nullable ImageView iconView) {
            ...
            if (iconView != null) {
                ...
                if (hasText && iconView.getVisibility() == 0) {
                    bottomMargin = TabLayout.this.dpToPx(DEFAULT_GAP_TEXT_ICON);
                }
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        super.addView(this.mTabStrip, MODE_SCROLLABLE, new FrameLayout.LayoutParams(-2, -1));
        ...
        this.mTabTextSize = (float) ta.getDimensionPixelSize(android.support.v7.appcompat.R.styleable.TextAppearance_android_textSize, MODE_SCROLLABLE);
        ...
        this.mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.TabLayout_tabMinWidth, INVALID_WIDTH);
        this.mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.TabLayout_tabMaxWidth, INVALID_WIDTH);
    ...
    private void setupWithViewPager(@Nullable ViewPager viewPager, boolean autoRefresh, boolean implicitSetup) {
        ...
        if (viewPager != null) {
            ...
            setScrollPosition(viewPager.getCurrentItem(), AutoScrollHelper.RELATIVE_UNSPECIFIED, true);
        } else {
    ...
    void populateFromPagerAdapter() {
        ...
        if (this.mPagerAdapter != null) {
            ...
            for (int i = MODE_SCROLLABLE; i < adapterCount; i++) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                child.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), CitySearchProvider.GET_SEARCH_RESULT_SUCC), getChildMeasureSpec(heightMeasureSpec, getPaddingTop() + getPaddingBottom(), child.getLayoutParams().height));
            }
        }
    }
    ...
    private void ensureScrollAnimator() {
        if (this.mScrollAnimator == null) {
            ...
            this.mScrollAnimator.addUpdateListener(new AnimatorUpdateListener() {
                public void onAnimationUpdate(ValueAnimator animator) {
                    TabLayout.this.scrollTo(((Integer) animator.getAnimatedValue()).intValue(), MODE_SCROLLABLE);
                }
            });
        }
    }
    ...
    private int getDefaultHeight() {
        ...
        int count = this.mTabs.size();
        for (int i = MODE_SCROLLABLE; i < count; i++) {
