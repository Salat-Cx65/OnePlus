...
class SnackbarManager {
    ...
    public void show(int duration, Callback callback) {
        synchronized (this.mLock) {
            ...
            if (this.mCurrentSnackbar == null || !cancelSnackbarLocked(this.mCurrentSnackbar, RainSurfaceView.RAIN_LEVEL_RAINSTORM)) {
    ...
    void handleTimeout(SnackbarRecord record) {
        synchronized (this.mLock) {
            if (this.mCurrentSnackbar == record || this.mNextSnackbar == record) {
                cancelSnackbarLocked(record, RainSurfaceView.RAIN_LEVEL_SHOWER);
            }
        }
    }
}
