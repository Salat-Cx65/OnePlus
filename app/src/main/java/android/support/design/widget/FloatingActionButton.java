...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    class AnonymousClass_1 implements InternalVisibilityChangedListener {
        ...
        AnonymousClass_1(OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        private static boolean isBottomSheet(@NonNull View view) {
            ...
            return lp instanceof LayoutParams ? ((LayoutParams) lp).getBehavior() instanceof BottomSheetBehavior : false;
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mBackgroundTintMode = ViewUtils.parseTintMode(a.getInt(R.styleable.FloatingActionButton_backgroundTintMode, SIZE_AUTO), null);
        this.mRippleColor = a.getColor(R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = a.getInt(R.styleable.FloatingActionButton_fabSize, SIZE_AUTO);
        this.mBorderWidth = a.getDimensionPixelSize(R.styleable.FloatingActionButton_borderWidth, 0);
        float elevation = a.getDimension(R.styleable.FloatingActionButton_elevation, AutoScrollHelper.RELATIVE_UNSPECIFIED);
        float pressedTranslationZ = a.getDimension(R.styleable.FloatingActionButton_pressedTranslationZ, AutoScrollHelper.RELATIVE_UNSPECIFIED);
    ...
    private InternalVisibilityChangedListener wrapOnVisibilityChangedListener(@Nullable OnVisibilityChangedListener listener) {
        return listener == null ? null : new AnonymousClass_1(listener);
    }
    ...
    private int getSizeDimension(int size) {
        ...
        switch (size) {
            case SIZE_AUTO:
                return Math.max(res.getConfiguration().screenWidthDp, res.getConfiguration().screenHeightDp) < 470 ? getSizeDimension(SIZE_MINI) : getSizeDimension(0);
            case SIZE_MINI:
    ...
    private FloatingActionButtonImpl createImpl() {
        return VERSION.SDK_INT >= 21 ? new FloatingActionButtonLollipop(this, new ShadowDelegateImpl()) : new FloatingActionButtonImpl(this, new ShadowDelegateImpl());
    }
}
