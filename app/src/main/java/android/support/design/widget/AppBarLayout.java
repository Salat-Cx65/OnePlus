...
public class AppBarLayout extends LinearLayout {
    ...
    public static class Behavior extends HeaderBehavior<AppBarLayout> {
        ...
        class AnonymousClass_1 implements AnimatorUpdateListener {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                android.support.design.widget.AppBarLayout.Behavior.this.setHeaderTopBottomOffset(this.val$coordinatorLayout, this.val$child, ((Integer) animation.getAnimatedValue()).intValue());
            }
        }
        ...
        private void snapToChildIfNeeded(CoordinatorLayout coordinatorLayout, AppBarLayout abl) {
            ...
            if (offsetChildIndex >= 0) {
                ...
                if ((flags & 17) == 17) {
                    ...
                    animateOffsetTo(coordinatorLayout, abl, MathUtils.clamp(newOffset, -abl.getTotalScrollRange(), 0), AutoScrollHelper.RELATIVE_UNSPECIFIED);
                }
            }
        }
        ...
        boolean canDragView(AppBarLayout view) {
            ...
            return (scrollingView == null || !scrollingView.isShown() || scrollingView.canScrollVertically(INVALID_POSITION)) ? false : true;
        }
        ...
        int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, AppBarLayout appBarLayout, int newOffset, int minOffset, int maxOffset) {
            ...
            if (minOffset == 0 || curOffset < minOffset || curOffset > maxOffset) {
                ...
                if (curOffset != newOffset) {
                    ...
                    updateAppBarLayoutDrawableState(coordinatorLayout, appBarLayout, newOffset, newOffset < curOffset ? INVALID_POSITION : PENDING_ACTION_EXPANDED, false);
                }
            }
            return consumed;
        }
    ...
    private void setExpanded(boolean expanded, boolean animate, boolean force) {
        int i = 0;
        int i2 = (animate ? PENDING_ACTION_ANIMATE_ENABLED : 0) | (expanded ? 1 : 2);
        if (force) {
