...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    protected void onStart() {
        super.onStart();
        if (this.mBehavior != null) {
            this.mBehavior.setState(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
        }
    }
    ...
    private static int getThemeResId(Context context, int themeId) {
        ...
        return context.getTheme().resolveAttribute(R.attr.bottomSheetDialogTheme, outValue, true) ? outValue.resourceId : R.style.Theme_Design_Light_BottomSheetDialog;
    }
}
