...
class ViewUtilsApi14 implements ViewUtilsImpl {
    ...
    public void setAnimationMatrix(@NonNull View view, Matrix matrix) {
        if (matrix == null || matrix.isIdentity()) {
            ...
            view.setScaleX(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            view.setScaleY(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT);
            view.setRotation(AutoScrollHelper.RELATIVE_UNSPECIFIED);
            return;
        }
        ...
        float dx = values[2];
        float dy = values[5];
        view.setPivotX(AutoScrollHelper.RELATIVE_UNSPECIFIED);
        view.setPivotY(AutoScrollHelper.RELATIVE_UNSPECIFIED);
