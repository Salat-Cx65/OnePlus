...
public class TransitionSet extends Transition {
    ...
    class AnonymousClass_1 extends TransitionListenerAdapter {
        ...
        AnonymousClass_1(Transition transition) {
    ...
    public Transition getTransitionAt(int index) {
        return (index < 0 || index >= this.mTransitions.size()) ? null : (Transition) this.mTransitions.get(index);
    }
    ...
    protected void runAnimators() {
        ...
        for (int i = ORDERING_SEQUENTIAL; i < this.mTransitions.size(); i++) {
            ((Transition) this.mTransitions.get(i - 1)).addListener(new AnonymousClass_1((Transition) this.mTransitions.get(i)));
        }
