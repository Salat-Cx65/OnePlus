...
public abstract class Visibility extends Transition {
    ...
    class AnonymousClass_1 extends AnimatorListenerAdapter {
        ...
        AnonymousClass_1(ViewGroupOverlayImpl viewGroupOverlayImpl, View view) {
    ...
    public Animator onDisappear(ViewGroup sceneRoot, TransitionValues startValues, int startVisibility, TransitionValues endValues, int endVisibility) {
        ...
        if (overlayView != null && startValues != null) {
            ...
            ViewGroupOverlayImpl overlay = ViewGroupUtils.getOverlay(sceneRoot);
            ...
            animator.addListener(new AnonymousClass_1(overlay, overlayView));
            return animator;
