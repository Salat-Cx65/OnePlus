...
public class PatternPathMotion extends PathMotion {
    ...
    public PatternPathMotion() {
        ...
        this.mPatternPath.lineTo(DefaultRetryPolicy.DEFAULT_BACKOFF_MULT, AutoScrollHelper.RELATIVE_UNSPECIFIED);
    ...
    public void setPatternPath(Path patternPath) {
        ...
        float endX = pos[0];
        float endY = pos[1];
        pathMeasure.getPosTan(AutoScrollHelper.RELATIVE_UNSPECIFIED, pos, null);
        float startX = pos[0];
        float startY = pos[1];
