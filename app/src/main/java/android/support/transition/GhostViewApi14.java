...
class GhostViewApi14 extends View implements GhostViewImpl {
    ...
    GhostViewApi14(View view) {
        ...
        this.mView = view;
        setLayerType(RainSurfaceView.RAIN_LEVEL_SHOWER, null);
    }
    ...
    protected void onAttachedToWindow() {
        ...
        this.mView.setVisibility(RainSurfaceView.RAIN_LEVEL_RAINSTORM);
    }
    ...
    public void setVisibility(int visibility) {
        ...
        this.mView.setVisibility(visibility == 0 ? RainSurfaceView.RAIN_LEVEL_RAINSTORM : 0);
    }
