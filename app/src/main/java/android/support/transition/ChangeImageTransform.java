...
public class ChangeImageTransform extends Transition {
    ...
    static class AnonymousClass_2 extends Property<ImageView, Matrix> {
    ...
    static {
        ...
        ANIMATED_TRANSFORM_PROPERTY = new AnonymousClass_2(Matrix.class, "animatedTransform");
    }
    ...
    private static Matrix copyImageMatrix(ImageView view) {
        switch (AnonymousClass_3.$SwitchMap$android$widget$ImageView$ScaleType[view.getScaleType().ordinal()]) {
