...
class ViewUtils {
    ...
    static class AnonymousClass_1 extends Property<View, Float> {
    ...
    static class AnonymousClass_2 extends Property<View, Rect> {
    ...
    static {
        ...
        TRANSITION_ALPHA = new AnonymousClass_1(Float.class, "translationAlpha");
        CLIP_BOUNDS = new AnonymousClass_2(Rect.class, "clipBounds");
    }
